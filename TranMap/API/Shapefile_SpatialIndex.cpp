...
void  CShapefile::get_HasSpatialIndex(VARIANT_BOOL *pVal)
{
...
// *****************************************************************
//ajp June 2008 Property does spatial index exist
void  CShapefile::put_HasSpatialIndex(VARIANT_BOOL pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CShapefile::get_UseSpatialIndex(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_useSpatialIndex)
	{
...
void  CShapefile::put_UseSpatialIndex(VARIANT_BOOL pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CShapefile::put_SpatialIndexMaxAreaPercent(DOUBLE newVal)
{
	_spatialIndexMaxAreaPercent = newVal;
	return ;
}
void  CShapefile::get_SpatialIndexMaxAreaPercent(DOUBLE* pVal)
{
...
void  CShapefile::get_CanUseSpatialIndex(CExtents* pArea, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = VARIANT_FALSE;
...
void  CShapefile::CreateSpatialIndex(BSTR ShapefileName, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		IsSpatialIndexValid()
// ***********************************************************
void  CShapefile::IsSpatialIndexValid(VARIANT_BOOL *retval)
{
...
// ********************************************************************
//Neio 2009/07/21 
void  CShapefile::QuickQueryInEditMode(CExtents *BoundBox, int ** Result, int* ResultCount )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		get_UseQTree()
// *****************************************************************
void  CShapefile::get_UseQTree(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		put_UseQTree()
// *****************************************************************
void  CShapefile::put_UseQTree(VARIANT_BOOL pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// 						RemoveSpatialIndex()				           
// **********************************************************************
void  CShapefile::RemoveSpatialIndex(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_TRUE;
	...
	for (int i = 0; i < 2; i++)
	{
		...
		CString name = W2A(_shpfileName.Left(_shpfileName.GetLength() - 3) + names[i]);
