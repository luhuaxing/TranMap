...
//		get/put_Key()
// **********************************************************
void CCharts::get_Key(BSTR *pVal)
{
...
void CCharts::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
	USES_CONVERSION;
...
// **********************************************************
void CCharts::get_VisibilityExpression(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CCharts::put_VisibilityExpression(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get/put_Caption()
// **********************************************************
void CCharts::get_Caption(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CCharts::put_Caption(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get/put_Visible()
// **********************************************************
void CCharts::get_Visible( VARIANT_BOOL *retVal )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.visible;
	return ;
}
void CCharts::put_Visible( VARIANT_BOOL newVal )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void CCharts::get_AvoidCollisions( VARIANT_BOOL *retVal )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.avoidCollisions;
	return ;
}
void CCharts::put_AvoidCollisions( VARIANT_BOOL newVal )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get/put_ChartType()
// **********************************************************
void CCharts::get_ChartType( tkChartType* retVal )
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.chartType;
	return ;
}
void CCharts::put_ChartType( tkChartType newVal )
{	
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void CCharts::get_BarWidth(long* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.barWidth;
	return ;
}
void CCharts::put_BarWidth(long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void CCharts::get_BarHeight(long* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.barHeight;
	return ;
}
void CCharts::put_BarHeight(long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void CCharts::get_PieRadius (long* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.radius;
	return ;
}
void CCharts::put_PieRadius (long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void CCharts::get_PieRotation (double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.rotation;
	return ;
}
void CCharts::put_PieRotation (double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_NumBars
// **********************************************************
void CCharts::get_NumFields (long* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _bars.size();
	return ;
...
//		AddBar()
// **********************************************************
void CCharts::AddField2(long FieldIndex, OLE_COLOR Color)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CCharts::AddField(CChartField* Field, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (!Field)	
	{
...
//		InsertField2()
// **********************************************************
void CCharts::InsertField2 (long Index, long FieldIndex, OLE_COLOR Color, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	{
		CChartField* chartField = new CChartField();
...
//		InsertField()
// **********************************************************
void CCharts::InsertField(long Index, CChartField* Field, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(Index < 0 || Index > (long)_bars.size())
	{	
...
//		RemoveBar()
// **********************************************************
void CCharts::RemoveField(long Index, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(Index < 0 || Index > (long)_bars.size())
	{	
...
//		MoveBar()
// **********************************************************
void CCharts::MoveField(long OldIndex, long NewIndex, VARIANT_BOOL* vbretval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		SetPositions
// **********************************************************
void CCharts::Generate(tkLabelPositioning Position, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (!_shapefile)
	{
...
// *******************************************************************
// For inner use only
void CCharts::put_ParentShapefile(CShapefile* newVal)
{
	_shapefile = newVal;
}
CShapefile* CCharts::get_ParentShapefile()
{
	return _shapefile;
}
...
//		Thickness
// **********************************************************
void CCharts::get_Thickness(double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.thickness;
	return ;
}
void CCharts::put_Thickness(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		Tilt
// **********************************************************
void CCharts::get_Tilt(double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.tilt; 
	return ;
}
void CCharts::put_Tilt(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		PieRadius2
// **********************************************************
void CCharts::get_PieRadius2(LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.radius2;
	return ;
}
void CCharts::put_PieRadius2(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		SizeField
// **********************************************************
void CCharts::get_SizeField(LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.sizeField;
	return ;
}
void CCharts::put_SizeField(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		NormalizationField
// **********************************************************
void CCharts::get_NormalizationField(LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.normalizationField;
	return ;
}
void CCharts::put_NormalizationField(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		UseVariableRadius
// **********************************************************
void CCharts::get_UseVariableRadius(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.useVariableRadius;
	return ;
}
void CCharts::put_UseVariableRadius(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		Transparency
// **********************************************************
void CCharts::get_Transparency(SHORT* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = (short)_options.transparency;
	return ;
}
void CCharts::put_Transparency(SHORT newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		LineColor
// **********************************************************
void CCharts::get_LineColor(OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.lineColor;
	return ;
}
void CCharts::put_LineColor(OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		3DMode
// **********************************************************
void CCharts::get_Use3DMode(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.use3Dmode;
	return ;
}
void CCharts::put_Use3DMode(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		VerticalPosition
// **********************************************************
void CCharts::get_VerticalPosition (tkVerticalPosition* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _options.verticalPosition;
	return ;
}
void CCharts::put_VerticalPosition (tkVerticalPosition newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Chart
// **********************************************************
void CCharts::get_Chart(long ShapeIndex, CChart** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Field
// **********************************************************
void CCharts::get_Field (long FieldIndex, CChartField** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_LastErrorCode
// *************************************************************
void CCharts::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_ErrorMsg
// *************************************************************
void CCharts::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// *************************************************************
void CCharts::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _globalCallback;
	return ;
}
void CCharts::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get/put_NumCharts
// *************************************************************
void CCharts::get_Count(long *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!_shapefile)
	{
...
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	CShapefile* sf = this->get_ParentShapefile();
	if (sf)
	{
...
//		DrawChart()
// **************************************************************
void CCharts::DrawChart(int** hdc, float x, float y, VARIANT_BOOL hideLabels, OLE_COLOR backColor, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		DrawChartVB()
// **************************************************************
void CCharts::DrawChartVB(int hdc, float x, float y, VARIANT_BOOL hideLabels, OLE_COLOR backColor, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	CDC* dc = CDC::FromHandle((HDC)hdc);
	*retVal = DrawChartCore(dc, x, y, hideLabels, backColor);
...
//			get_IconWidth()
// **************************************************************
void CCharts::get_IconWidth(long *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//			get_IconWidth()
// **************************************************************
void CCharts::get_IconHeight(long *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
		if (_options.chartType == chtBarChart)
	{
...
//		FontName()
// *****************************************************************
void CCharts::get_ValuesFontName(BSTR* retval)					
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CCharts::put_ValuesFontName(BSTR newVal)					
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CCharts::Select(CExtents* BoundingBox, long Tolerance, SelectMode SelectMode, VARIANT* Indices, VARIANT_BOOL* retval)
{
	*retval = VARIANT_FALSE;
...
//     Serialize()
// ********************************************************
void CCharts::Serialize(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
		...
		else if (_savingMode == modeXML || _savingMode == modeXMLOverwrite)
		{
			if (_shapefile)
			{
				...
				if (sourceType == sstDiskBased)
				{
					...
					CString path = W2A( Utility::GetPathWOExtension(A2W(OLE2T(name))));
					path += ".chart";
...
bool CCharts::DeserializeCore(CPLXMLNode* node)
{
	...
	if (nodeFields)
	{
		...
		while (node)
		{
			...
			{
				CChartField* field = new CChartField();
	...
	else if (_savingMode == modeXML || _savingMode == modeXMLOverwrite)
	{
		if (_shapefile)
		{
			...
			if (sourceType == sstDiskBased)
			{
				...
				_shapefile->get_Filename(&name);
				USES_CONVERSION;
				CString path = W2A(Utility::GetPathWOExtension(OLE2W(name)));
				path += ".chart";
...
//     Deserialize()
// ********************************************************
void CCharts::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		SaveToXML()
// *******************************************************
void CCharts::SaveToXML(BSTR Filename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
...
//		get_SavingMode()
// *************************************************************
void CCharts::get_SavingMode(tkSavingMode* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _savingMode;
	return ;
...
//		put_SavingMode()
// *************************************************************
void CCharts::put_SavingMode(tkSavingMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	_savingMode = newVal;
	return ;
...
//		LoadFromXML()
// *******************************************************
void CCharts::LoadFromXML(BSTR Filename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
