...
void  CUtils::PointInPolygon(CShape *Shape, CPointClass *TestPoint, VARIANT_BOOL *retval)
{
...
void  CUtils::GridReplace(CGrid *Grid, VARIANT OldValue, VARIANT NewValue, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CUtils::GridInterpolateNoData(CGrid *Grid, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ************************************************************
void  CUtils::RemoveColinearPoints(CShapefile * Shapes, double LinearTolerance, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::get_Length(CShape *Shape, double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::get_Perimeter(CShape *Shape, double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::get_Area(CShape *Shape, double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( Shape == NULL )	
	{	
...
//In multi-part polygons, clockwise parts are filled while counter-clockwise parts are holes.
//Returns true if clockwise, false if counter-clockwise.
bool CUtils::is_clockwise(CShape *Shape)
{
	long numPoints = 0;
	Shape->get_NumPoints(&numPoints);
	double area = 0;
...
void  CUtils::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CUtils::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CUtils::GridMerge(VARIANT Grids, BSTR MergeFilename, VARIANT_BOOL InRam, GridFileType GrdFileType, ICallback *cBack, CGrid **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	...
	{	
		...
		//Determine if the IUnknown supports the CGrid Interface
	...
	CGridHeader * final_header =new CGridHeader();
...
void  CUtils::ShapeMerge(CShapefile *Shapes, long IndexOne, long IndexTwo, ICallback *cBack, CShape **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::GridToGrid(CGrid *Grid, GridDataType OutDataType, ICallback *cBack, CGrid **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CUtils::ShapeToShapeZ(CShapefile * Shapefile, CGrid *Grid, ICallback *cBack, CShapefile **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::TinToShapefile(CTin *Tin, ShpfileType Type, ICallback *cBack, CShapefile **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	...
	*retval = new CShapefile();
	//CoCreateInstance(CLSID_Shapefile,NULL,CLSCTX_INPROC_SERVER,IID_CShapefile,(void**)retval);
	...
	{	
		...
		{			
			...
			CPointClass * point = new CPointClass();
			point->put_X(x1);
			point->put_Y(y1);
			point->put_Z(z1);
			pos = 0;
...
//    GridToShapefile()
// ***************************************************
void  CUtils::GridToShapefile(CGrid *Grid, CGrid *ConnectionGrid, ICallback *cBack, CShapefile **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	long fieldpos = 0;
	CField * field = new CField();
	//CoCreateInstance(CLSID_Field,NULL,CLSCTX_INPROC_SERVER,IID_CField,(void**)&field);
				...
				if( polygon.size() > 3 )
				{
					...
					{	
						...
						{	if( last_point_index < 0 )
							...
							CPointClass * ipoint = new CPointClass();
							ipoint->put_X(poly_x);
							ipoint->put_Y(poly_y);
							long pindex = point;
...
inline bool CUtils::is_decision( CGrid * g, int x, int y )
{	
...
inline double CUtils::getValue( CGrid * Grid, long column, long row )
{	VARIANT vval;
	VariantInit(&vval); 
...
inline void CUtils::setValue( CGrid * Grid, long column, long row, double val )
{	VARIANT vval;
	VariantInit(&vval); 
	vval.vt = VT_R8;
	vval.dblVal = val;
...
void  CUtils::ShapefileToGrid(CShapefile * Shpfile, VARIANT_BOOL UseShapefileBounds, CGridHeader * GridHeader, double Cellsize, VARIANT_BOOL UseShapeNumber, short SingleValue,CGrid ** retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		PolygonToGrid()
// *******************************************************************
bool CUtils::PolygonToGrid(CShape * shape, CGrid ** grid, short cellValue)
{
	LineBresenham Line;
	std::vector<lbPoint> ListOfPoints;
	lbPoint StartPoint, EndPoint;
	CPointClass * shpPoint = NULL;
	long NumPoints = 0;
	double CurX;
	double CurY;
...
void  CUtils::hBitmapToPicture(long hBitmap, IPictureDisp **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CUtils::GenerateHillShade(BSTR  bstrGridFilename, BSTR  bstrShadeFilename, 
...
//	  OGRLayerToShapefile()
// ***********************************************************
void  CUtils::OGRLayerToShapefile(BSTR Filename, ShpfileType shpType, ICallback *cBack, CShapefile** sf)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	ICallback* callback = cBack ? cBack : _globalCallback;
...
void  CUtils::ClipPolygon(PolygonOperation op, CShape* SubjectPolygon, CShape* ClipPolygon, CShape** retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = NULL;
	...
	{
		CShape* shp = ClipperConverter::ClipPolygon(ClipPolygon, SubjectPolygon, op);
		*retval = shp;
	}
	return ;
}
...
//		MergeImages
// ******************************************************************
void  CUtils::MergeImages(/*[in]*/SAFEARRAY* InputNames, /*[in]*/BSTR OutputName, /*out,retval*/VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
	USES_CONVERSION;
...
//		ReprojectShapefile()
// ***********************************************************
void  CUtils::ReprojectShapefile(CShapefile* sf, CGeoProjection* source, CGeoProjection* target, CShapefile** result)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CUtils::ColorByName(tkMapColor name, OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		ConvertDistance()
// **************************************************************
void  CUtils::ConvertDistance(tkUnitsOfMeasure sourceUnit, tkUnitsOfMeasure targetUnit, DOUBLE* value, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		ClipGridWithPolygon()
// **************************************************************
void  CUtils::ClipGridWithPolygon(BSTR inputGridfile, CShape* poly, BSTR resultGridfile, VARIANT_BOOL keepExtents, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************
void  CUtils::ClipGridWithPolygon2(CGrid* grid, CShape* poly, BSTR resultGridfile, VARIANT_BOOL keepExtents, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************
void CreateStatisticsFields(CShapefile* sf, std::vector<long>& resultIndices, bool overwrite) 
{
...
//		GridStatsToForPoly()
// ********************************************************
bool GridStatsForPoly(CGrid* grid, CGridHeader* header, CShape* poly, Extent& bounds,
...
// ********************************************************
void  CUtils::GridStatisticsForPolygon(CGrid* grid, CGridHeader* header, CExtents* gridExtents, CShape* shape, 
...
// ********************************************************
void  CUtils::GridStatisticsToShapefile(CGrid* grid,  CShapefile* sf, VARIANT_BOOL selectedOnly, VARIANT_BOOL overwriteFields, VARIANT_BOOL* retVal) 
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
	if (!grid || !sf) {
...
void  CUtils::GeodesicDistance(double lat1, double lng1, double lat2, double lng2, double* retVal) 
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     MaskRaster()
// ********************************************************
void  CUtils::MaskRaster(BSTR filename, BYTE newPerBandValue, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
...
//     CopyNodataValues()
// ********************************************************
void  CUtils::CopyNodataValues(BSTR sourceFilename, BSTR destFilename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
	GDALAllRegister();
...
void  CUtils::ErrorMsgFromObject(IDispatch * comClass, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (!comClass)
	{
	...
	CField* Field = NULL;
	//comClass->QueryInterface(IID_CField, (void**)(&Field));
	if (Field) 
	{
	...
	CGeoProjection* GeoProjection = NULL;
	//comClass->QueryInterface(IID_CGeoProjection, (void**)(&GeoProjection));
	if (GeoProjection) 
	{
		GeoProjection->get_LastErrorCode(&errorCode);
		get_ErrorMsg(errorCode, retVal);
		delete GeoProjection;
		return ;
	}
	...
	//CLabelCategory* LabelCategory = NULL;
	...
	//CLineSegment* LineSegment = NULL;

	//CMeasuring* Measuring = NULL;
	...
	CShapeDrawingOptions* ShapeDrawingOptions = NULL;
	...
	if (ShapeDrawingOptions) 
	{
		...
		get_ErrorMsg(errorCode, retVal);
		delete ShapeDrawingOptions;
		return ;
	}

	CShapefile* Shapefile = NULL;
	//comClass->QueryInterface(IID_CShapefile, (void**)(&Shapefile));
	if (Shapefile) 
	{
	...
	CShapefileCategories* ShapefileCategories = NULL;
	//comClass->QueryInterface(IID_CShapefileCategories, (void**)(&ShapefileCategories));
	if (ShapefileCategories) 
	{
		ShapefileCategories->get_LastErrorCode(&errorCode);
		get_ErrorMsg(errorCode, retVal);
		delete ShapefileCategories;
		return ;
	}

	//CShapefileCategory* ShapefileCategory = NULL;

	//CShapefileColorBreak* ShapefileColorBreak = NULL;

#ifdef OLD_API
	CShapefileColorScheme* ShapefileColorScheme = NULL;
	comClass->QueryInterface(IID_CShapefileColorScheme, (void**(&ShapefileColorScheme));
	...
	CShapeNetwork* ShapeNetwork = NULL;
	...
	CTileProviders* TileProviders = NULL;
	...
	//CShapeValidationInfo* ShapeValidationInfo = NULL;

	CFieldStatOperations* FieldStatOperations = NULL;
	//comClass->QueryInterface(IID_CFieldStatOperations, (void**)(&FieldStatOperations));
	if (FieldStatOperations) 
	{
		FieldStatOperations->get_LastErrorCode(&errorCode);
		get_ErrorMsg(errorCode, retVal);
		delete FieldStatOperations;
		return ;
	}
...
// ********************************************************
HRESULT CUtils::TileProjectionToGeoProjectionCore(tkTileProjection projection, VARIANT_BOOL useCache, CGeoProjection** retVal)
{
	*retVal = NULL;
...
// ********************************************************
void  CUtils::TileProjectionToGeoProjection(tkTileProjection projection, CGeoProjection** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	TileProjectionToGeoProjectionCore(projection, VARIANT_FALSE, retVal);
}

// ********************************************************
//     ComUsageReport()
// ********************************************************
void  CUtils::get_ComUsageReport(VARIANT_BOOL unreleasedOnly, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     CalculateRaster()
// ********************************************************
void  CUtils::CalculateRaster(SAFEARRAY* InputNames, BSTR expression, BSTR outputFilename, BSTR gdalOutputFormat,
...
//     ReclassifyRaster()
// ********************************************************
void  CUtils::ReclassifyRaster(BSTR Filename, int bandIndex, BSTR outputName, SAFEARRAY* LowBounds, 
...
//			IsTiffGrid()						  
// *************************************************
void  CUtils::IsTiffGrid(BSTR Filename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
