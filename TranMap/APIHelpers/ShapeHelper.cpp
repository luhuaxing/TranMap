...
//		GetShapeType
// *****************************************************
ShpfileType ShapeHelper::GetShapeType(CShape* shp)
{
...
//		GetShapeType2D
// *****************************************************
ShpfileType ShapeHelper::GetShapeType2D(CShape* shp)
{
	if (!shp) return SHP_NULLSHAPE;
	ShpfileType shpType;
...
//		PointWithinShape
// *****************************************************
bool ShapeHelper::PointInThisPoly(CShape* shp, double x, double y)
{
	if (!shp) return false;
...
//		PointWithinShape
// *****************************************************
bool ShapeHelper::BoundPointsInPolygon(CShape* shp, double b_minX, double b_minY, double b_maxX, double b_maxY)
{
...
//		PointWithinShape
// *****************************************************
bool ShapeHelper::PointWithinShape(CShape* shape, double projX, double projY, double Tolerance)
{
...
//		get_MemShapePoints
// **************************************************************
BOOL ShapeHelper::get_MemShapePoints(CShape* shape, ShpfileType & ShapeType, std::vector<long> & parts, std::vector<double> & xPts, std::vector<double> & yPts)
{
	double x, y;
	long part;
...
bool ShapeHelper::ForceProperShapeType(CShape* shp, ShpfileType sfType)
{
	ShpfileType shapeType;
...
//     SplitByPolyline()
// *************************************************************
bool ShapeHelper::SplitByPolyline(CShape* subject, CShape* polyline, vector<CShape*>& shapes)
{
	return (subject)->SplitByPolylineCore(polyline, shapes);
}

// *************************************************************
//     IsEmpty()
// *************************************************************
bool ShapeHelper::IsEmpty(CShape* shp)
{
	if (!shp) return true;
	VARIANT_BOOL vb;
	shp->get_IsEmpty(&vb);
...
//		GetNumParts()
// *************************************************************
long ShapeHelper::GetNumParts(CShape* shp)
{
	if (!shp) return 0;
	long numParts;
...
//		GetLargestPart()
// *************************************************************
int ShapeHelper::GetLargestPart(CShape* shp)
{
	if (!shp) return -1;
...
//		AddLabel()
// *************************************************************
void ShapeHelper::AddLabelToShape(CShape* shp, CLabels* labels, BSTR text, tkLabelPositioning method, tkLineLabelOrientation orientation)
{
