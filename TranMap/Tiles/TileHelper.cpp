...
//		GetTileSizeProj()
// ************************************************************
double TileHelper::GetTileSizeProj(VARIANT_BOOL isSameProjection, BaseProvider* provider, CGeoProjection* wgsToMapTransformation, 
...
//		Transform()
// ************************************************************
bool TileHelper::Transform(RectLatLng& Geog, CGeoProjection* proj, BaseProjection* baseProj, 
