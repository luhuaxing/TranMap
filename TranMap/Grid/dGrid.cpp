...
double dGrid::getValue( int Column, int Row )
{
	if( inGrid( Column ,Row ) )
	{
		if( isInRam )
...
double dGrid::getValueDisk( int Column, int Row )
{	if( gridType == ASCII_GRID )
		return gridHeader.getNodataValue();
	else if( gridType == BINARY_GRID )
...
void dGrid::setValueDisk( int Column, int Row, double Value )
{	if( gridType == ASCII_GRID )
		return;
	else if( gridType == BINARY_GRID )
...
bool dGrid::inGrid( long column, long row )
{
