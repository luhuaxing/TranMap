...
//			SetConversionFactor()
// *********************************************************************
void ClipperConverter::SetConversionFactor(CShapefile* sf)
{
	if (!sf) return;
...
OGRGeometry* OgrConverter::ShapeToGeometry(CShape* shape, OGRwkbGeometryType forceGeometryType)
{
	if( shape == NULL)
		return NULL;
 ...
 */
bool OgrConverter::GeometryToShapes(OGRGeometry* oGeom, vector<CShape *>* vShapes, bool isM, 
 ...
 */
CShape * OgrConverter::GeometryToShape(OGRGeometry* oGeom, bool isM, 
 ...
 */
CShapefile* OgrConverter::ReadOgrLayer(BSTR Filename, ICallback* callback)
{
	CShapefile* sf = NULL;
...
bool OgrConverter::WriteOgrLayer(CShapefile* sf, BSTR Filename)
{
	return false;
}
