...
//DATA ACCESS MEMBERS
long lHeader::getNumberCols()
{	return ncols;
}

long lHeader::getNumberRows()
{	return nrows;
}

long lHeader::getNodataValue()
{	return nodataValue;
}

double lHeader::getDx()
{	return dx;
}

double lHeader::getDy()
{	return dy;
}

double lHeader::getXllcenter()
{	return xllcenter;
}

double lHeader::getYllcenter()
{	return yllcenter;
}
