...
// ****************************************************************
CPointClass* GeoShape::GetPolygonCenter(Gdiplus::PointF* data, int length)
{
...
//		GetWgs84Projection()
// ***************************************************************
CGeoProjection* GeoShape::GetWgs84Projection()
{
...
//		GetMapProjection()
// ***************************************************************
CGeoProjection* GeoShape::GetMapProjection()
{
