...
//		GetShapeType2D
// ************************************************************
ShpfileType EditorHelper::GetShapeType2D(CShapeEditor* editor)
{
...
//		IsEmpty
// ************************************************************
bool EditorHelper::IsEmpty(CShapeEditor* editor)
{
...
//		CopyOptionsFrom()
// *******************************************************
void EditorHelper::CopyOptionsFrom(CShapeEditor* editor, CShapefile* sf)
{
	if (!sf || !editor) return;
...
void EditorHelper::CopyOptionsFrom(CShapeEditor* editor, CShapeDrawingOptions* options)
{
...
//		GetSnappingBehavior()
// *******************************************************
tkLayerSelection EditorHelper::GetSnappingBehavior(CShapeEditor* editor)
{
