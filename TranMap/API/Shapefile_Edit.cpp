...
//		StartEditingShapes()
// ************************************************************
void  CShapefile::StartEditingShapes(VARIANT_BOOL StartEditTable, ICallback *cBack, VARIANT_BOOL *retval)
{
...
//		StopEditingShapes()
// ********************************************************
void  CShapefile::StopEditingShapes(VARIANT_BOOL ApplyChanges, VARIANT_BOOL StopEditTable, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
	...
	if( _table == NULL || _sourceType == sstUninitialized)
		return ;		// don't report anything as StopEditingShapes will be called from Close for any InMemoryShapefile
...
void CShapefile::RegisterNewShape(CShape* Shape, long ShapeIndex)
{
...
void  CShapefile::EditUpdateShape(long shapeIndex, CShape* shpNew, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
	if (!_isEditingShapes) 
...
//		EditInsertShape()
// ***********************************************************
void  CShapefile::EditInsertShape(CShape *Shape, long *ShapeIndex, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					_table->set_IndexValue(*ShapeIndex);
...
//		EditDeleteShape()
// *********************************************************************
void  CShapefile::EditDeleteShape(long ShapeIndex, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//		EditClear()
// ***********************************************************
void  CShapefile::EditClear(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//		get_CacheExtents()
// ****************************************************************
void  CShapefile::get_CacheExtents(VARIANT_BOOL * pVal)
{
...
//		put_CacheExtents()
// ****************************************************************
void  CShapefile::put_CacheExtents(VARIANT_BOOL newVal)
{
	// The property no longer used
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return ;
...
//		RefreshExtents()
// ********************************************************************
void  CShapefile::RefreshExtents(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		RefreshShapeExtents()
// ********************************************************************
void  CShapefile::RefreshShapeExtents(LONG ShapeId, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BOOL CShapefile::VerifyMemShapes(ICallback * cBack)
{
	...
	long numPoints;
	long numParts;
	CPointClass * firstPnt = NULL;
	CPointClass * lastPnt = NULL;
...
// ****************************************************************
void  CShapefile::get_InteractiveEditing(VARIANT_BOOL* pVal)
{
	*pVal = _isEditingShapes && _interactiveEditing;
	return ;
}
void  CShapefile::put_InteractiveEditing(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (!_isEditingShapes && newVal)
	{
		...
		return ;  // error code in previous code
	}
