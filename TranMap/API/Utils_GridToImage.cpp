...
//		ReadBreaks()
// ****************************************************************
void ReadBreaks(CGridColorScheme* ci, std::deque<BreakVal>& result)
{
	long numBreaks = 0;
...
//		GetLightSource()
// ****************************************************************
void GetLightSource(CGridColorScheme* ci, cppVector& lightsource)
{
	// TODO: can be moved to CGridColorScheme
	double lsi, lsj, lsk;
	CVector * v = NULL;
	ci->GetLightSource(&v);
	v->get_i(&lsi);
...
//		WritePixel()
// ****************************************************************
inline void CUtils::WritePixel(CImageClass* img, int row, int col, OLE_COLOR color,
...
//		GridToImage()
// *************************************************************************
void  CUtils::GridToImage(CGrid *Grid, CGridColorScheme *ci, ICallback *cBack, CImageClass ** retval)
{
	...
	RunGridToImage(Grid, ci, gpfBmpProxy, inRam, false, cBack, retval);
	return;
}
...
// *************************************************************************
void  CUtils::GridToImage2(CGrid * Grid, CGridColorScheme * ci, tkGridProxyFormat imageFormat, VARIANT_BOOL inRam, ICallback* cBack, CImageClass ** retval)
{
	RunGridToImage(Grid, ci, imageFormat, inRam == VARIANT_TRUE, true, cBack, retval);
	return;
}
...
//		RunGridToImage()
// *************************************************************************
HRESULT CUtils::RunGridToImage(CGrid * Grid, CGridColorScheme * ci, tkGridProxyFormat imageFormat, 
							   bool inRam, bool checkMemory, ICallback* callback, CImageClass ** retval)
{
	...
	else
	{
		...
		*retval = new CImageClass();
		...
		{
			WorldFile = Utility::GetPathWOExtension(imageFile) + L".bpw";
...
// *************************************************************************
void CUtils::GridToImageCore(CGrid *Grid, CGridColorScheme *ci, ICallback *cBack, bool inRam, CImageClass ** retval)
{
