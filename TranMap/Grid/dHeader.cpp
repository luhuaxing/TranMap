...
//DATA ACCESS MEMBERS
 long dHeader::getNumberCols()
{	return ncols;
}

 long dHeader::getNumberRows()
{	return nrows;
}

 double dHeader::getNodataValue()
{	return nodataValue;
}

 double dHeader::getDx()
{	return dx;
}

 double dHeader::getDy()
{	return dy;
}

 double dHeader::getXllcenter()
{	return xllcenter;
}

 double dHeader::getYllcenter()
{	return yllcenter;
}
