...
bool tkRaster::LoadRasterCore(CStringA& filename, GDALAccess accessType)
{
	...
	__try
	{
		...
		//Rob JPEG2000 fails at this point with a nasty error if TranMap is 
...
bool tkRaster::ReadGridAsImage2(colour** ImageData, int xOff, int yOff, int width, int height, int xBuff, int yBuff, bool setRGBToGrey) 
{
	...
	CGridColorScheme* gridColorScheme = GetColorSchemeForRendering();
	long numBreaks = 0;
...
CGridColorScheme* tkRaster::GetColorSchemeForRendering()
{
	long numBreaks;	
