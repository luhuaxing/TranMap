...
//	Run
// ***************************************************************
bool GroupOperation::Run(tkCursorMode cursorMode, long layerHandle, CShapefile* sf, CShape* shp, CUndoList* undoList, int& errorCode)
{
	if (!sf || !undoList || !shp)  {
...
//	EraseByPolygon
// ***************************************************************
bool GroupOperation::ClipByPolygon(tkCursorMode cursorMode, long layerHandle, CShapefile* sf, vector<long>& indices, CShape*polygon, CUndoList* undoList, int& errorCode)
{
...
//	SplitByPolyline
// ***************************************************************
bool GroupOperation::SplitByPolyline(long layerHandle, CShapefile* sf, vector<long>& indices, 
		CShape* polyline, CUndoList* undoList, int& errorCode)
{
	vector<long> deleteList;
