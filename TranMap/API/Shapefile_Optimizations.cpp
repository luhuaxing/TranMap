...
//		get_fastMode()
// ************************************************************
void  CShapefile::get_FastMode (VARIANT_BOOL* retval)
{
...
//	  put_FastMode()
// ************************************************************
void  CShapefile::put_FastMode (VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	   get_NumPoints()
// *****************************************************************
void  CShapefile::get_NumPoints(long ShapeIndex, long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
bool  CShapefile::QuickPoint(long ShapeIndex, long PointIndex, CPointClass **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// *****************************************************************
//This function does not extract Z or M values!!!!!!!!
void  CShapefile::QuickPoints(long ShapeIndex, long *NumPoints, SAFEARRAY ** retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = NULL;
	*NumPoints = 0;
...
void  CShapefile::QuickExtents(long ShapeIndex, CExtents **retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = NULL;
