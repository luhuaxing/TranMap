...
VARIANT_BOOL CImageClass::WriteWorldFile(CStringW WorldFileName)
{
	...
	//19-Oct-09 Rob Cairns: setlocale in case TranMap is made locale aware again in future
...
//		Resource()
// *********************************************************
void  CImageClass::Resource(BSTR newImgPath, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
...
//	  Open()
// ************************************************************
void  CImageClass::Open(BSTR ImageFileName, ImageType FileType, VARIANT_BOOL InRam, ICallback *cBack, VARIANT_BOOL *retval)
{
...
// ***************************************************************
void CImageClass::LoadImageAttributesFromGridColorScheme(CGridColorScheme* scheme)
{
	if (scheme)
	{
		OLE_COLOR color;
		...
		if (Utility::FileExistsW(legendName))
		{
			...
			if (nameW.GetLength() > 0)
			{
				...
				if (Utility::FileExistsW(gridName))
				{
					...
					VARIANT_BOOL vb;
					CGridColorScheme* scheme = new CGridColorScheme();
...
//	  Save()
// *************************************************************
void  CImageClass::Save(BSTR ImageFileName, VARIANT_BOOL WriteWorldFile, ImageType FileType, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  CreateNew()
// **********************************************************
void  CImageClass::CreateNew(long NewWidth, long NewHeight, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  Close()
// **********************************************************
void  CImageClass::Close(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  Clear()
// **********************************************************
void  CImageClass::Clear(OLE_COLOR CanvasColor, ICallback *CBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  GetRow()
// **********************************************************
void  CImageClass::GetRow(long Row, long *Vals, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::get_Width(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _width;
	return ;
...
//stored in the ImageData variable
void  CImageClass::get_Height(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _height;
	return ;
...
//		get_Value()
// *****************************************************************
void  CImageClass::get_Value(long row, long col, long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		put_Value()
// *****************************************************************
void  CImageClass::put_Value(long row, long col, long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_IsInRam
// **************************************************************
void  CImageClass::get_IsInRam(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		TransparencyColor
// **************************************************************
void  CImageClass::get_TransparencyColor(OLE_COLOR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _transColor;
	return ;
...
void  CImageClass::put_TransparencyColor(OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		TransparencyColor2
// **************************************************************
void  CImageClass::get_TransparencyColor2(OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _transColor2;
	return ;
}
void  CImageClass::put_TransparencyColor2(OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::get_UseTransparencyColor(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _useTransColor;
	return ;
...
void  CImageClass::put_UseTransparencyColor(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
	_lastErrorCode = tkNO_ERROR;
...
void  CImageClass::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CImageClass::get_CdlgFilter(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  get_GlobalCallback()
// **********************************************************
void  CImageClass::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  get_Key()
// **********************************************************
void  CImageClass::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
...
//	  get_FileHandle()
// **********************************************************
void  CImageClass::get_FileHandle(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  get_ImageType()
// **********************************************************
void  CImageClass::get_ImageType(ImageType *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  get_Filename()
// **********************************************************
void  CImageClass::get_Filename(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CImageClass::SetVisibleExtents(double newMinX, double newMinY,	double newMaxX, double newMaxY, long pixInView, float transPercent)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Picture()
// ***********************************************************************
void  CImageClass::get_Picture(IPictureDisp **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
# include <ATLCTL.H>
void  CImageClass::putref_Picture(IPictureDisp *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		GetImageBitsDC()
// *****************************************************************
void  CImageClass::GetImageBitsDC(long hDC, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::SetImageBitsDC(long hDC, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
void  CImageClass::SetProjection(BSTR Proj4, VARIANT_BOOL * retval)
{
	USES_CONVERSION;
...
//		GetProjection
// ****************************************************************
void  CImageClass::GetProjection(BSTR * Proj4)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::get_OriginalWidth(LONG* OriginalWidth)
{   
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::get_OriginalHeight(LONG* OriginalHeight)
{  
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::get_AllowHillshade(VARIANT_BOOL * pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::put_AllowHillshade(VARIANT_BOOL newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
void  CImageClass::get_SetToGrey(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _setRGBToGrey;
	return ;
...
void  CImageClass::put_SetToGrey(VARIANT_BOOL newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::get_UseHistogram(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::put_UseHistogram(VARIANT_BOOL newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
void  CImageClass::get_HasColorTable(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
void  CImageClass::get_PaletteInterpretation(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CImageClass::get_BufferSize(int *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::put_BufferSize(int newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
void  CImageClass::get_NoBands(int *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		ClearGDALCache
// **************************************************************
void  CImageClass::get_ClearGDALCache(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _gdalImage ? _rasterImage->clearGDALCache : VARIANT_FALSE;
	return ;
}
void  CImageClass::put_ClearGDALCache(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage)
	{
...
//		TransparencyPercent
// **************************************************************
void  CImageClass::get_TransparencyPercent(double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::put_TransparencyPercent(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		DownsamplingMode
// **************************************************************
void  CImageClass::get_DownsamplingMode(tkInterpolationMode* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _downsamplingMode;
	return ;
}
void  CImageClass::put_DownsamplingMode(tkInterpolationMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		UpsamplingMode
// **************************************************************
void  CImageClass::get_UpsamplingMode(tkInterpolationMode* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _upsamplingMode;
	return ;
}
void  CImageClass::put_UpsamplingMode(tkInterpolationMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		Drawing method
// **************************************************************
void  CImageClass::get_DrawingMethod(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal =_drawingMethod;
	return ;
}
void  CImageClass::put_DrawingMethod(int newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		BuildOverviews
// **************************************************************
void  CImageClass::BuildOverviews (tkGDALResamplingMethod ResamplingMethod, int numOverviews, SAFEARRAY* OverviewList, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = VARIANT_FALSE;
...
//  Returns reference to Labels class
 void  CImageClass::get_Labels(CLabels** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _labels;
	//if (_labels != NULL)
...
void  CImageClass::put_Labels(CLabels* newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (newVal == NULL)
	{
...
//		get_Extents()
// ********************************************************************
void  CImageClass::get_Extents(CExtents** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::ProjectionToImage(double ProjX, double ProjY, long* ImageX, long* ImageY)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage)
	{
...
void  CImageClass::ImageToProjection(long ImageX, long ImageY, double* ProjX, double* ProjY)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// **************************************************************
// Returns image coordinates to the given map coordinates
void  CImageClass::ProjectionToBuffer(double ProjX, double ProjY, long* BufferX, long* BufferY)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// **************************************************************
// Returns map coordinates to the given image coordinates
void  CImageClass::BufferToProjection(long BufferX, long BufferY, double* ProjX, double* ProjY)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// **************************************************************
void  CImageClass::get_CanUseGrouping (VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal =  (VARIANT_BOOL)_canUseGrouping;
	return ;
}
void  CImageClass::put_CanUseGrouping(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// **************************************************************
void  CImageClass::get_OriginalXllCenter( double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage && _rasterImage)
...
void  CImageClass::put_OriginalXllCenter( double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage && _rasterImage)
	{
...
// **************************************************************
void  CImageClass::get_OriginalYllCenter( double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage && _rasterImage)
...
void  CImageClass::put_OriginalYllCenter( double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage && _rasterImage)
	{		
...
//	 get/put_OriginalDX
// **************************************************************
void  CImageClass::get_OriginalDX( double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CImageClass::put_OriginalDX( double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if ( newVal > 0.0)
	{
...
//	 get/put_OriginalDY
// **************************************************************
void  CImageClass::get_OriginalDY( double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_gdalImage && _rasterImage)
...
void  CImageClass::put_OriginalDY( double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if ( newVal > 0.0)
	{
...
//	 get/put_OriginalYllCenter
// **************************************************************
void  CImageClass::get_YllCenter(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _yllCenter;
	return ;
}
void  CImageClass::put_YllCenter(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//	 get/put_OriginalXllCenter
// **************************************************************
void  CImageClass::get_XllCenter(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _xllCenter;
	return ;
...
void  CImageClass::put_XllCenter(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//	 get/put_dY
// **************************************************************
void  CImageClass::get_dY(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _dY;
	return ;
...
void  CImageClass::put_dY(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//	 get/put_dX
// **************************************************************
void  CImageClass::get_dX(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _dX;
	return ;
...
void  CImageClass::put_dX(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//	 GetUniqueColors
// **************************************************************
void  CImageClass::GetUniqueColors (double MaxBufferSizeMB, VARIANT* Colors, VARIANT* Frequencies, LONG* Count)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		SetNoDataValue()
// **************************************************************
void  CImageClass::SetNoDataValue(double Value, VARIANT_BOOL* Result)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())	
	if (_gdalImage && _rasterImage)
	{
...
//		get_NumOverviews()
// **************************************************************
void  CImageClass::get_NumOverviews(int* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())		
	*retval = 0;
	if (_gdalImage)
...
void  CImageClass::LoadBuffer(double maxBufferSize, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())		
	*retVal = VARIANT_FALSE;
...
//		get_SourceType()
// **************************************************************
void  CImageClass::get_SourceType (tkImageSourceType* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())		
	*retVal = _sourceType;
	return ;
...
// ***************************************************
void  CImageClass::GetOriginalXllCenter(double *pVal)
...
void  CImageClass::GetOriginalYllCenter(double *pVal)
{	// added by Rob Cairns 1-Jun-09
	AFX_MANAGE_STATE(AfxGetStaticModuleState()) 
	if (_gdalImage && _rasterImage )
	{
...
void  CImageClass::GetOriginal_dX(double *pVal)
{	// added by Rob Cairns 1-Jun-09
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage && _rasterImage )
		*pVal = _rasterImage->orig_dX;
...
void  CImageClass::GetOriginal_dY(double *pVal)
{	// added by Rob Cairns 1-Jun-09
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage && _rasterImage )
		*pVal = _rasterImage->orig_dY;
...
void  CImageClass::GetOriginalHeight(long *pVal)
{	// added by Rob Cairns 1-Jun-09
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CImageClass::GetOriginalWidth(long *pVal)
{	// added by Rob Cairns 1-Jun-09
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     get_Warped()
// ********************************************************
void  CImageClass::get_Warped(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     Serialize()
// ********************************************************
void  CImageClass::Serialize(VARIANT_BOOL SerializePixels, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     Deserialize()
// ********************************************************
void  CImageClass::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//     get_SourceGridName()
// ********************************************************
void  CImageClass::get_SourceGridName(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//     get_SourceFilename()
// ********************************************************
void  CImageClass::get_SourceFilename(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//     get_IsGridProxy()
// ********************************************************
void  CImageClass::get_IsGridProxy(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************
void  CImageClass::get_GridProxyColorScheme(CGridColorScheme** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = NULL;
	if (isGridProxy)
...
//     get_GridRendering()
// ********************************************************
void  CImageClass::get_GridRendering(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     AllowGridRendering
// ********************************************************
void  CImageClass::get_AllowGridRendering(tkGridRendering * pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _gdalImage ? _rasterImage->allowAsGrid : tkGridRendering::grForGridsOnly;
	return ;
}
void  CImageClass::put_AllowGridRendering(tkGridRendering newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//		_pushSchemetkRaster()
// *********************************************************
void  CImageClass::_pushSchemetkRaster(CGridColorScheme * cScheme, VARIANT_BOOL * retval)
{
	if (_gdalImage && _rasterImage )
	{
		if ( cScheme )
...
//     ImageColorScheme
// ********************************************************
void  CImageClass::get_ImageColorScheme(PredefinedColorScheme * pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _gdalImage ? _rasterImage->GetDefaultColors() : FallLeaves;
	return ;
}
void  CImageClass::put_ImageColorScheme(PredefinedColorScheme newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//     ImageColorScheme2
// ********************************************************
void  CImageClass::get_CustomColorScheme(CGridColorScheme** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage && _rasterImage )
	{
		CGridColorScheme* scheme = _rasterImage->get_CustomColorScheme();
		(*retVal) = scheme;
	}
	else
	{
...
void  CImageClass::put_CustomColorScheme(CGridColorScheme* newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	VARIANT_BOOL vb;
...
//     SetTransparentColor
// ********************************************************
void  CImageClass::SetTransparentColor(OLE_COLOR color)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     get_IsRgb
// ********************************************************
void  CImageClass::get_IsRgb(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//     OpenAsGrid
// ********************************************************
void  CImageClass::OpenAsGrid(CGrid** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = NULL;
...
//     SourceGridBandIndex
// ********************************************************
void  CImageClass::get_SourceGridBandIndex(int * pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _gdalImage ? _rasterImage->activeBandIndex : -1;
	return ;
}
void  CImageClass::put_SourceGridBandIndex(int newValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (_gdalImage)
	{
...
//     GeoProjection
// ********************************************************
void  CImageClass::get_GeoProjection(CGeoProjection** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     get_IsEmpty
// ********************************************************
void  CImageClass::get_IsEmpty(VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
