...
{	
 ...
 float fGrid::getValue( int Column, int Row )
{
	if( inGrid( Column, Row ) )
	{
		if( isInRam )
 ...
 float fGrid::getValueDisk( int Column, int Row )
{	if( gridType == ASCII_GRID )
		return gridHeader.getNodataValue();
	else if( gridType == BINARY_GRID )
 ...
 void fGrid::setValue( int Column, int Row, float Value )
{		
	if( inGrid( Column, Row ) )
	{	
 ...
 void fGrid::setValueDisk( int Column, int Row, float Value )
{	if( gridType == ASCII_GRID )
		return;
	else if( gridType == BINARY_GRID )
...
{	if( gridType == ASCII_GRID )
 ...
 bool fGrid::inGrid( long column, long row )
{
