...
/**********************************************************
			...
			not the implementation of CGridHeader COM Class
**********************************************************/
...
//DATA ACCESS MEMBERS
 long header::getNumberCols()
{	return ncols;
}

 long header::getNumberRows()
{	return nrows;
}

 double header::getNodataValue()
{	return nodataValue;
}
...
{	return dy;
 ...
 double header::getXllcenter()
{	return xllcenter;
}

 double header::getYllcenter()
{	return yllcenter;
}
