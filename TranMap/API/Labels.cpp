...
//		FontName()
// *****************************************************************
void  CLabels::get_FontName(BSTR* retval)					
{
...
void  CLabels::put_FontName(BSTR newVal)					
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
// *****************************************************************
void  CLabels::get_FontTransparency(long* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = _options.fontTransparency;		
	return ;
};		
void  CLabels::put_FontTransparency(long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CLabels::get_FrameTransparency(long* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = _options.frameTransparency;		
	return ;
};		
void  CLabels::put_FrameTransparency(long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (newVal < 0) newVal = 0;
	if (newVal > 255) newVal = 255;
...
//*		get_Key()
//***********************************************************************/
void  CLabels::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	*pVal = OLE2BSTR(_key);
...
void  CLabels::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
	USES_CONVERSION;
...
void  CLabels::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
...
void  CLabels::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CLabels::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CLabels::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Label
// ************************************************************
void  CLabels::get_Label(long Index, long Part, CLabelClass** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	else
	{
		...
		{
			CLabelClass* lbl = new CLabelClass();
			lbl->put_LabelData(reinterpret_cast<char*>(parts->at(Part)));
			*pVal = lbl;
		}
	}
	return ;
...
//*			get_NumCategories()
//***********************************************************************/
void  CLabels::get_NumCategories(long* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//*		get_numParts()
//***********************************************************************/
void  CLabels::get_NumParts(long Index, long* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( Index < 0 || Index >= (long)_labels.size() )
	{	
...
//*			get_Category()
//***********************************************************************/
void  CLabels::get_Category(long Index, CLabelCategory** retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = NULL;
...
//		put_Category
// ************************************************************
void  CLabels::put_Category(long Index, CLabelCategory* newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//*		AddLabel()
//***********************************************************************/
void  CLabels::AddLabel(BSTR Text, double x, double y, double Rotation, long Category)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//*		InsertLabel()
//***********************************************************************/
void  CLabels::InsertLabel(long Index, BSTR Text, double x, double y, double Rotation, long Category, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( Index < 0 || Index > (long)_labels.size() )
	{	
...
/*		RemoveLabel()
//***********************************************************************/
void  CLabels::RemoveLabel(long Index, VARIANT_BOOL* vbretval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( Index < 0 || Index >= (long)_labels.size() )
	{	
...
///*		AddPart()
///***********************************************************************/
void  CLabels::AddPart(long Index, BSTR Text, double x, double y, double Rotation, long Category)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
///*		AddPart()
///***********************************************************************/
void  CLabels::InsertPart(long Index, long Part, BSTR Text, double x, double y, double Rotation, long Category, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( Index < 0 || Index >=(int)_labels.size())
	{	
...
///*		RemovePart()
///***********************************************************************/
void  CLabels::RemovePart(long Index, long Part, VARIANT_BOOL* vbretval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//			AddCategory()
// *****************************************************************
void  CLabels::AddCategory(BSTR Name, CLabelCategory** retVal)
{
...
//			InsertCategory()
// *****************************************************************
void  CLabels::InsertCategory(long Index, BSTR Name, CLabelCategory** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	*retVal = NULL;
	CLabelCategory* cat = new CLabelCategory();
	if (cat == NULL) return ;
...
//			RemoveCategory()
// *****************************************************************
void  CLabels::RemoveCategory(long Index, VARIANT_BOOL* vbretval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*vbretval = VARIANT_FALSE;
...
//	  ApplyColorScheme()
// ********************************************************
void  CLabels::ApplyColorScheme (tkColorSchemeType Type, CColorScheme* ColorScheme)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  ApplyColorScheme2()
// ********************************************************
void  CLabels::ApplyColorScheme2 (tkColorSchemeType Type, CColorScheme* ColorScheme, tkLabelElements Element)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  ApplyColorScheme3()
// ********************************************************
void  CLabels::ApplyColorScheme3 (tkColorSchemeType Type, CColorScheme* ColorScheme, 
...
void  CLabels::Select(CExtents* BoundingBox, long Tolerance, SelectMode SelectMode, VARIANT* LabelIndices, VARIANT* PartIndices, VARIANT_BOOL* retval)
{
	*retval = VARIANT_FALSE;
...
// *******************************************************************
// For inner use only
void CLabels::put_ParentShapefile(CShapefile* newVal)
{
	_shapefile = newVal;
}
CShapefile* CLabels::get_ParentShapefile()
{
	return _shapefile;
}
...
//	    GenerateCategories()
// *****************************************************************
void  CLabels::GenerateCategories(long FieldIndex, tkClassificationType ClassificationType, long numClasses, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	*retVal = VARIANT_FALSE;
...
// *****************************************************************
void  CLabels::get_ClassificationField(long* FieldIndex)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*FieldIndex = _classificationField;
	return ;
}
void  CLabels::put_ClassificationField(long FieldIndex)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_classificationField = FieldIndex;
	return ;
...
// *****************************************************************
void  CLabels::put_Synchronized(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (newVal)
	{
...
void  CLabels::get_Synchronized(VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//			OptionsAsCategory()
// *****************************************************************
void  CLabels::get_Options(CLabelCategory** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CLabels::put_Options(CLabelCategory* newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	CLabelCategory* coCat =newVal;
...
// **********************************************************
void  CLabels::get_VisibilityExpression(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CLabels::put_VisibilityExpression(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// **********************************************************
void  CLabels::get_MinDrawingSize(LONG* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = _minDrawingSize;
	return ;
}
void  CLabels::put_MinDrawingSize(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		MoveUp
// ***************************************************************
void  CLabels::MoveCategoryUp (long Index, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (Index < (long)_categories.size() && Index > 0)
	{
		CLabelCategory* catBefore = _categories[Index - 1];
...
//		MoveDown
// ***************************************************************
void  CLabels::MoveCategoryDown (long Index, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (Index < (long)_categories.size() - 1 && Index >= 0)
	{
		CLabelCategory* catAfter = _categories[Index + 1];
		_categories[Index + 1] = _categories[Index];
...
//		get_AutoOffset
// ***************************************************************
void  CLabels::get_AutoOffset(VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = _autoOffset;
	return ;
}
void  CLabels::put_AutoOffset(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	_autoOffset = newVal;
	return ;
		...
		else if (_savingMode == modeXML || _savingMode == modeXMLOverwrite)
		{
			if (_shapefile)
			{
				...
				if (sourceType == sstDiskBased)
				{
					...
					path += L".lbl";
					if (_savingMode == modeXMLOverwrite && Utility::FileExists(W2A(path)))
					{
						if( remove(W2A(path) ) != 0 )
						{
					...
					if (!Utility::FileExists(W2A(path)))
					{
						VARIANT_BOOL retVal;
...
//     Serialize()
// ********************************************************
void  CLabels::Serialize(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     Deserialize()
// ********************************************************
void  CLabels::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//     get_Expression()
// ********************************************************
void  CLabels::get_Expression(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CLabels::put_Expression(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	...
	if (table)
	{
		...
		if (table->CalculateCore(str, results, strError, floatFormat))
		{
			// updating labels
...
//     SaveToXML()
// ********************************************************
void  CLabels::SaveToXML(BSTR filename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
...
//     LoadFromXML()
// ********************************************************
void  CLabels::LoadFromXML(BSTR filename, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = VARIANT_FALSE;
...
//     SaveLabels()
// ********************************************************
void  CLabels::SaveToDbf(VARIANT_BOOL saveText, VARIANT_BOOL saveCategory, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CLabels::SaveToDbf2(BSTR xField, BSTR yField, BSTR angleField, BSTR textField, BSTR categoryField,  
...
//     LoadLabels()
// ********************************************************
void  CLabels::LoadFromDbf(VARIANT_BOOL loadText, VARIANT_BOOL loadCategory, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	CComBSTR labelX("_LabelX");
	CComBSTR labelY("_LabelY");
...
void  CLabels::LoadFromDbf2(BSTR xField, BSTR yField, BSTR angleField, BSTR textField, BSTR categoryField, 
									 VARIANT_BOOL loadText, VARIANT_BOOL loadCategory, VARIANT_BOOL* retVal)
{
	...
	dbf->get_FieldValuesDouble((int)indices[0], xValues);

	std::vector<double> yValues;
	dbf->get_FieldValuesDouble((int)indices[1], yValues);
	
	//angles
	std::vector<double> vAngles;
	if (loadAngle)
		dbf->get_FieldValuesDouble((int)indices[2], vAngles);

	// text
	std::vector<CString> vText;
	if (loadText)
		dbf->get_FieldValuesString((int)indices[3], vText);

	// category
	std::vector<int> vCategory;
	if (loadCategory)
		dbf->get_FieldValuesInteger((int)indices[4], vCategory);
...
//			Generate
// ************************************************************
void  CLabels::Generate(BSTR Expression, tkLabelPositioning Method, VARIANT_BOOL LargestPartOnly, long* Count)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if (!_shapefile)
	{
	...
	table->ParseExpressionCore(Expression, vtString, error, &vbretval);
...
//		get_SavingMode()
// *************************************************************
void  CLabels::get_SavingMode(tkSavingMode* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _savingMode;
	return ;
...
//		put_SavingMode()
// *************************************************************
void  CLabels::put_SavingMode(tkSavingMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	_savingMode = newVal;
	return ;
...
//		get_Positioning()
// *************************************************************
void  CLabels::get_Positioning(tkLabelPositioning* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _positioning;
	return ;
...
//		put_Positioning()
// *************************************************************
void  CLabels::put_Positioning(tkLabelPositioning newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_shapefile)
	{
...
//		TextRenderingHint()
// *************************************************************
void  CLabels::get_TextRenderingHint(tkTextRenderingHint* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CLabels::put_TextRenderingHint(tkTextRenderingHint newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// *************************************************************
void  CLabels::get_FloatNumberFormat(BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// *************************************************************
void  CLabels::put_FloatNumberFormat(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	...
	CString s;
	s.Format(format, 1.1);
	if (SysStringLen(newVal) == 0) return ;
	if (s != format) {
...
//		ReapplyExpression()
// *************************************************************
void  CLabels::ForceRecalculateExpression()
{
	CComBSTR expr;
	get_Expression(&expr);
