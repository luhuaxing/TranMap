...
{	
 ...
 short sGrid::getValue( int Column, int Row )
{
	if( inGrid( Column, Row ) )
	{
		if( isInRam )
 ...
 short sGrid::getValueDisk( int Column, int Row )
{	if( gridType == ASCII_GRID )
		return gridHeader.getNodataValue();
	else if( gridType == BINARY_GRID )
...
{		
 ...
 void sGrid::setValueDisk( int Column, int Row, short Value )
{	if( gridType == ASCII_GRID )
		return;
	else if( gridType == BINARY_GRID )
...
{	if( gridType == ASCII_GRID )
 ...
 bool sGrid::inGrid( long column, long row )
{
