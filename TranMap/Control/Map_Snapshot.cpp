...
//		SnapShot()
// *********************************************************
CImageClass* CMapView::SnapShot(LPDISPATCH BoundBox)
{
	if( BoundBox == NULL )
	{	
...
CImageClass* CMapView::SnapShot2(LONG ClippingLayerNbr, DOUBLE Zoom, long pWidth)
{   
	...
	return SnapShotCore(left, right, top, bottom, Width, Height);
}
...
CImageClass* CMapView::SnapShot3(double left, double right, double top, double bottom, long Width)
{   
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//    TilesAreInCache()
// *********************************************************************
INT CMapView::TilesAreInCache(CExtents* Extents, LONG WidthPixels, tkTileProvider provider)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
void CMapView::LoadTilesForSnapshot(CExtents* Extents, LONG WidthPixels, LPCTSTR Key, tkTileProvider provider)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//    SnapShotToDC2()
// *********************************************************************
BOOL CMapView::SnapShotToDC2(PVOID hdc, CExtents* Extents, LONG Width, float OffsetX, float OffsetY,
...
BOOL CMapView::SnapShotToDC(PVOID hdc, CExtents* Extents, LONG Width)
{
...
CImageClass* CMapView::SnapShotCore(double left, double right, double top, double bottom, long Width, long Height, CDC* snapDC,
