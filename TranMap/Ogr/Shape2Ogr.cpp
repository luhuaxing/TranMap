...
//		Shapefile2OgrLayer()
// *************************************************************
bool Shape2Ogr::Shapefile2OgrLayer(CShapefile* sf, OGRLayer* poLayer, bool saveLabels, ICallback* callback /*= NULL*/)
{
...
// *************************************************************
bool Shape2Ogr::ShapefileFieldsToOgr(CShapefile* sf, OGRLayer* poLayer)
{
	long numFields;
...
//		ShapesToOgr()
// *************************************************************
void Shape2Ogr::ShapesToOgr(CShapefile* sf, OGRLayer* poLayer, ICallback* callback)
{
...
//		ShapeRecord2Feature()
// *************************************************************
bool Shape2Ogr::ShapeRecord2Feature(CShapefile* sf, long shapeIndex, OGRFeature* feature,
...
// *************************************************************
int Shape2Ogr::SaveShapefileChanges(OGRLayer* poLayer, CShapefile* shapefile, long shapeCmnIndex, tkOgrSaveType saveType,
...
// *************************************************************
int Shape2Ogr::RemoveDeletedFeatures(OGRLayer* layer, CShapefile* sf, long shapeCmnIndex)
{
	int count = 0;
