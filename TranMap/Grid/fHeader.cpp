...
//DATA ACCESS MEMBERS
 long fHeader::getNumberCols()
{	return ncols;
}

 long fHeader::getNumberRows()
{	return nrows;
}

 float fHeader::getNodataValue()
{	return nodataValue;
}

 double fHeader::getDx()
{	return dx;
}

 double fHeader::getDy()
{	return dy;
}

 double fHeader::getXllcenter()
{	return xllcenter;
}

 double fHeader::getYllcenter()
{	return yllcenter;
}
