...
void CMapView::SetGlobalCallback(ICallback* newValue)
{
	...
	// lu newValue->QueryInterface(IID_ICallback, (void**)&cback);
...
//		GetTiles
// *****************************************************
CTiles* CMapView::GetTiles(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return _tiles;
}

CTiles* CMapView::GetTilesNoRef(void)
{
	return _tiles;
}
...
//		GetFileManager
// *****************************************************
CFileManager* CMapView::GetFileManager(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return _fileManager;
}
...
//		GetIdentifier
// *****************************************************
CIdentifier* CMapView::GetIdentifier(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return _identifier;
}
