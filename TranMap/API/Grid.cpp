...
void  CGrid::get_RasterColorTableColoringScheme(CGridColorScheme **pVal)
{
	*pVal = NULL;
	if (!_trgrid) {
		return ;
...
//		get_Header()
// ***************************************************
void  CGrid::get_Header(CGridHeader **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;

	*pVal = new CGridHeader();
...
//		AssignNewProjection()
// ***************************************************
void  CGrid::AssignNewProjection(BSTR projection, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
...
//		Resource()
// ***************************************************
void  CGrid::Resource(BSTR newSrcPath, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
...
//		GetRow()
// ***************************************************
void  CGrid::GetRow(long Row, float *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		GetRow2()
// ***************************************************
void  CGrid::GetRow2(long Row, double *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGrid::PutRow2(long Row, double *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		PutRow()
// ***************************************************
void  CGrid::PutRow(long Row, float *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ***************************************************
void  CGrid::SetInvalidValuesToNodata(double MinThresholdValue, double MaxThresholdValue, VARIANT_BOOL * retval)
{
...
//		get_Value()
// ***************************************************
void  CGrid::get_Value(long Column, long Row, VARIANT *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		put_Value()
// ***************************************************
void  CGrid::put_Value(long Column, long Row, VARIANT newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_InRam()
// ***************************************************
void  CGrid::get_InRam(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Maximum()
// ***************************************************
void  CGrid::get_Maximum(VARIANT *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Minimum()
// ***************************************************
void  CGrid::get_Minimum(VARIANT *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_DataType()
// ***************************************************
void  CGrid::get_DataType(GridDataType *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_LastErrorCode()
// ***************************************************
void  CGrid::get_Filename(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_LastErrorCode()
// ***************************************************
void  CGrid::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_ErrorMsg()
// ***************************************************
void  CGrid::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		GlobalCallback()
// ***************************************************
void  CGrid::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _globalCallback;
	return ;
}
void  CGrid::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGrid::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
...
void CGrid::SaveProjectionAsWkt()
{
	...
	{
		CGeoProjection* proj = new CGeoProjection();
		if (proj)
		{
			VARIANT_BOOL vb;
...
//		Open()
// ***************************************************
void  CGrid::Open(BSTR Filename, GridDataType DataType, VARIANT_BOOL InRam, GridFileType FileType, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState()) 
	USES_CONVERSION;
...
// ***************************************************
#pragma warning (disable:4244)
void  CGrid::CreateNew(BSTR Filename, CGridHeader *Header, GridDataType DataType, VARIANT InitialValue, 
	...
	else
	{
			...
			|| extension.CompareNoCase("dt1") == 0)))   // TODO: reuse the code from Open
		{
			...
			if (_trgrid->CanCreate(newFileType))
			{
				...
				bool result = _trgrid->CreateNew(OLE2W(Filename), newFileType, dx, dy, xllcenter, yllcenter, 
...
//		Close()
// ***************************************************
void  CGrid::Close(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		Save()
// ***************************************************
void  CGrid::Save(BSTR Filename, GridFileType  FileType, ICallback * cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	...
	*retval = VARIANT_FALSE;
		...
		|| FileType == PCIDsk || FileType == DTed || FileType == GeoTiff))
	{
		...
		bRetval = tempGrid->CreateNew(OLE2W(Filename), FileType, tempGrid->getDX(), tempGrid->getDY(), tempGrid->getXllCenter(), tempGrid->getYllCenter(), tempGrid->noDataValue, prj, tempGrid->getWidth(), tempGrid->getHeight(), newDataType, true, tempGrid->noDataValue, false);
		delete [] prj;
		if (!bRetval) return ;
		...
		bRetval = tempGrid->Save(OLE2W(Filename), FileType);
		if (!bRetval) return ;
...

	{
		...
		for (int i = 0; i < numCols; i++)
		{
			for (int j = 0; j < numRows; j++)
			{
				...
				tempGrid->put_Value(i, j, vPval); // The order here is correct (i,j) -- this is CGrid.
			}
		}
		VariantClear(&vPval); 
	...
	{
		if( _trgrid->Save(OLE2W(Filename), FileType) )
		{	
			_filename = Filename;
			*retval = VARIANT_TRUE;
		}
...
//		Clear()
// ***************************************************
void  CGrid::Clear(VARIANT ClearValue, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		ProjToCell()
// ***************************************************
void  CGrid::ProjToCell(double x, double y, long *Column, long *Row)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		CellToProj()
// ***************************************************
void  CGrid::CellToProj(long Column, long Row, double *x, double *y)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_CdlgFilter()
// ***************************************************
void  CGrid::get_CdlgFilter(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		GetFloatWindow()
// ***************************************************
void  CGrid::GetFloatWindow(long StartRow, long EndRow, long StartCol, long EndCol, float *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		GetFloatWindow2()
// ***************************************************
void  CGrid::GetFloatWindow2(long StartRow, long EndRow, long StartCol, long EndCol, double *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		PutFloatWindow()
// ***************************************************
void  CGrid::PutFloatWindow(long StartRow, long EndRow, long StartCol, long EndCol, float *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		PutFloatWindow2()
// ***************************************************
void  CGrid::PutFloatWindow2(long StartRow, long EndRow, long StartCol, long EndCol, double *Vals, VARIANT_BOOL * retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Extents()
// ******************************************************************
void  CGrid::get_Extents(CExtents** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = NULL;
...
//		Clone()
// ******************************************************
CGrid* CGrid::Clone(BSTR newFilename)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	
	CGridHeader* newHeader = new CGridHeader();
...
//		Clip()
// **************************************************************
CGrid* CGrid::Clip(BSTR newFilename, long firstCol, long lastCol, long firstRow, long lastRow)
{
	CGridHeader* newHeader = new CGridHeader();
...
//		get_NumBands()
// **************************************************************
void  CGrid::get_NumBands(int *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_trgrid != NULL)
	{
...
//		get_ActiveBandIndex()
// **************************************************************
void  CGrid::get_ActiveBandIndex(int *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		OpenBand()
// **************************************************************
void  CGrid::OpenBand(int bandIndex, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
...
//						get_SourceType()						         
// ****************************************************************
void  CGrid::get_SourceType (tkGridSourceType* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())		
	if (_trgrid)
	{
...
//						OpenAsImage()						         
// ****************************************************************
void  CGrid::OpenAsImage(CGridColorScheme* scheme, tkGridProxyMode proxyMode, ICallback* cBack, CImageClass** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = NULL;
...
//						OpenAsDirectImage()						         
// ****************************************************************
void CGrid::OpenAsDirectImage(CGridColorScheme* scheme, ICallback* cBack, CImageClass** retVal)
{
	VARIANT_BOOL vb;
	...
	if (vb)
	{
		*retVal = img;
		...
		if (vb){
				...
				img->isGridProxy = false;
				
				// grab transparent color from image and save in color scheme
				img->get_UseTransparencyColor(&vb);
				if (vb)
				{
					OLE_COLOR transparentColor;
					img->get_TransparencyColor(&transparentColor);
				...
				if (m_globalSettings.saveGridColorSchemeToFile) 
				{
					...
					//lu 2019.8.15scheme->WriteToFile(bstrName, bstrGridName, bandIndex, &vb);
				}

			// let's build overviews for direct grid
//lu			GdalHelper::BuildOverviewsIfNeeded(gridName, true, _globalCallback);
		}
		else {
...
//			OpenImageProxy()						         
// ****************************************************************
CImageClass* CGrid::OpenImageProxy()
{
...
//			RemoveImageProxy()						         
// ****************************************************************
void  CGrid::RemoveImageProxy(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//			PreferedDisplayMode()						         
// ****************************************************************
void  CGrid::get_PreferedDisplayMode(tkGridProxyMode *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _preferedDisplayMode;
	return ;
}
void  CGrid::put_PreferedDisplayMode(tkGridProxyMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ****************************************************************
#include "Utils.h"
void  CGrid::CreateImageProxy(CGridColorScheme* colorScheme, CImageClass** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	VARIANT_BOOL vb;
	RemoveImageProxy(&vb);
...
// ****************************************************************
void  CGrid::get_HasValidImageProxy(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ****************************************************************
void  CGrid::RetrieveOrGenerateColorScheme(tkGridSchemeRetrieval retrievalMethod, tkGridSchemeGeneration generateMethod, 
												  PredefinedColorScheme colors, CGridColorScheme** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = NULL;
...
bool schemeIsValid(CGridColorScheme** scheme)
{
...
//		RetrieveColorScheme()						         
// ****************************************************************
void  CGrid::RetrieveColorScheme(tkGridSchemeRetrieval method, CGridColorScheme** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = NULL;
	CGridColorScheme* scheme = NULL;
	scheme = new CGridColorScheme();
	VARIANT_BOOL vb;
...
//			GenerateColorScheme()						         
// ****************************************************************
void  CGrid::GenerateColorScheme(tkGridSchemeGeneration method, PredefinedColorScheme colors, CGridColorScheme** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = NULL;
	CGridColorScheme* scheme = NULL;
...
bool CGrid::BuildUniqueColorScheme(int maxValuesCount, PredefinedColorScheme colors, ColoringType coloringType, CGridColorScheme** newScheme)
{
	*newScheme = NULL;
	...
	CGridColorScheme* result = new CGridColorScheme();
	if (result)
	{
		...
		while (it != values.end())
		{
			...
			// add break for value
			CGridColorBreak * brk = new CGridColorBreak();
...
// ****************************************************************
CGridColorScheme* CGrid::BuildGradientColorSchemeCore(PredefinedColorScheme colors, ColoringType coloringType)
{
	CComVariant max, min;
