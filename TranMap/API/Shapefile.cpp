...
{	
	...
	_charts = NULL;
	_geoProjection = NULL;
	_inputValidation = new CShapeValidationInfo();
	_outputValidation = new CShapeValidationInfo();

	_selectDrawOpt = new CShapeDrawingOptions();
	_defaultDrawOpt = new CShapeDrawingOptions();
	_categories = new CShapefileCategories();
	_labels = new CLabels();
	_charts = new CCharts();
	_geoProjection = new CGeoProjection();
...
{			
	...
	if (_selectDrawOpt != NULL)
		delete _selectDrawOpt;

	if (_defaultDrawOpt != NULL)
		delete _defaultDrawOpt;

	if (_labels != NULL)
	{
		put_ReferenceToLabels(true);	// labels class maybe referenced by client and won't be deleted as a result
		delete _labels;			// therefore we must clear the reference to the parent as it will be invalid
	}
...
void CShapefile::SetValidationInfo(CShapeValidationInfo* info, tkShapeValidationType validationType)
{
...
//		get_EditingShapes()
// ************************************************************
void  CShapefile::get_EditingShapes(VARIANT_BOOL *pVal)
{
...
//		get_LastErrorCode()
// ************************************************************
void  CShapefile::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
	_lastErrorCode = tkNO_ERROR;
...
//		get_CdlgFilter()
// ************************************************************
void  CShapefile::get_CdlgFilter(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		LastInputValidation
// ************************************************************
void  CShapefile::get_LastInputValidation(CShapeValidationInfo** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ************************************************************
void  CShapefile::get_LastOutputValidation(CShapeValidationInfo** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
// ************************************************************
void  CShapefile::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CShapefile::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		StopExecution
// ************************************************************
void  CShapefile::put_StopExecution(CStopExecution* stopper)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
		_stopExecution = stopper;
	return ;
}
...
//		get/put_Key()
// ************************************************************
void  CShapefile::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	*pVal = OLE2BSTR(_key);
...
void  CShapefile::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
...
// ************************************************************
void  CShapefile::get_VisibilityExpression(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CShapefile::put_VisibilityExpression(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_expression);
...
//		get/put_Volatile
// ************************************************************
void  CShapefile::get_Volatile(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CShapefile::put_Volatile(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_NumShapes()
// *****************************************************************
void  CShapefile::get_NumShapes(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_NumFields()
// **************************************************************
void  CShapefile::get_NumFields(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( _table != NULL )
...
//		get_ShapefileType()
// ************************************************************
void  CShapefile::get_ShapefileType(ShpfileType *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _shpfiletype;
	return ;
...
//	   get_ErrorMsg()
// *****************************************************************
void  CShapefile::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//	   get_FileHandle()
// *****************************************************************
void  CShapefile::get_FileHandle(long * pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( _shpfile != NULL )
	{	
...
//	   get_Filename()
// **************************************************************
void  CShapefile::get_Filename(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_MinDrawingSize()
// ************************************************************
void  CShapefile::get_MinDrawingSize(LONG* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _minDrawingSize;
	return ;
}
void  CShapefile::put_MinDrawingSize(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		get_SourceType()
// ************************************************************
void  CShapefile::get_SourceType(tkShapefileSourceType* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _sourceType;
	return ;
...
void  CShapefile::LoadDataFrom(BSTR ShapefileName, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	*retval = VARIANT_FALSE;
	...
	{
		if (OpenCore(OLE2W(ShapefileName), cBack))
		{
...
//		Open()
// ************************************************************
void  CShapefile::Open(BSTR ShapefileName, ICallback *cBack, VARIANT_BOOL *retval)
{	
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
	VARIANT_BOOL vbretval;
...
//		CreateNew()
// *********************************************************
void  CShapefile::CreateNew(BSTR ShapefileName, ShpfileType ShapefileType, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	this->CreateNewCore(ShapefileName, ShapefileType, true ,retval);
	return ;
}
...
// *********************************************************
void  CShapefile::CreateNewWithShapeID(BSTR ShapefileName, ShpfileType ShapefileType, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		Close()
// *****************************************************************
void  CShapefile::Close(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	...
	{
		delete _inputValidation;
		_inputValidation = NULL;
	}

	if (_outputValidation != NULL)
	{
		delete _outputValidation;
...
void  CShapefile::Dump(BSTR ShapefileName, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
void  CShapefile::SaveAs(BSTR ShapefileName, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
void  CShapefile::Save(ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//		Resource()
// ************************************************************
void  CShapefile::Resource(BSTR newShpPath, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
	Close(retval);
...
void  CShapefile::Clone(CShapefile** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_Extents()
// ************************************************************
void  CShapefile::get_Extents(CExtents **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  EditInsertField()
// ****************************************************************
void  CShapefile::EditInsertField(CField *NewField, long *FieldIndex, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  EditDeleteField()
// ****************************************************************
void  CShapefile::EditDeleteField(long FieldIndex, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  EditCellValue()
// ****************************************************************
void  CShapefile::EditCellValue(long FieldIndex, long ShapeIndex, VARIANT NewVal, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  StartEditingTable()
// ****************************************************************
void  CShapefile::StartEditingTable(ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	  StopEditingTable()
// ****************************************************************
void  CShapefile::StopEditingTable(VARIANT_BOOL ApplyChanges, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	   get_Field()
// *****************************************************************
void  CShapefile::get_Field(long FieldIndex, CField **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//lu			//if ((*pVal)->get_GlobalCallback(&cBack) == NULL && this->_globalCallback != NULL)
			//	(*pVal)->put_GlobalCallback(_globalCallback);
			
			if (cBack != NULL)
				delete cBack;	// we put a reference in field class so must release it here
		}
	}
	else
	{	
...
//	   get_FieldByName()
// *****************************************************************
void  CShapefile::get_FieldByName(BSTR Fieldname, CField **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//	   get_CellValue()
// *****************************************************************
void  CShapefile::get_CellValue(long FieldIndex, long ShapeIndex, VARIANT *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	   get_EditingTable()
// *****************************************************************
void  CShapefile::get_EditingTable(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if( _table != NULL )
	{
...
//		get_Table()
// *************************************************************
void  CShapefile::get_Table(CTableClass** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _table;
	return ;
...
//		get_ShapeRotation()
// *************************************************************
void  CShapefile::get_ShapeRotation(long ShapeIndex, double* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CShapefile::put_ShapeRotation(long ShapeIndex, double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{	
...
//		get_ShapeVisible()
// *************************************************************
void  CShapefile::get_ShapeVisible(long ShapeIndex, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = VARIANT_FALSE;
	if (ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
...
//		ShapeIsHidden()
// *************************************************************
void  CShapefile::get_ShapeIsHidden(LONG shapeIndex, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (shapeIndex < 0 || shapeIndex >= (long)_shapeData.size())
	{
...
void  CShapefile::put_ShapeIsHidden(LONG shapeIndex, VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (shapeIndex < 0 || shapeIndex >= (long)_shapeData.size())
	{
...
//		get_ShapeModified()
// *************************************************************
void  CShapefile::get_ShapeModified(long ShapeIndex, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{
...
void  CShapefile::put_ShapeModified(long ShapeIndex, VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{
...
//		get_ShapeCategory()
// *************************************************************
void  CShapefile::get_ShapeCategory(long ShapeIndex, long* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CShapefile::put_ShapeCategory(long ShapeIndex, long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size()) //_numShapes )
	{	
...
//		get_ShapeCategory2()
// *************************************************************
void  CShapefile::put_ShapeCategory2(long ShapeIndex, BSTR categoryName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{	
...
void  CShapefile::get_ShapeCategory2(long ShapeIndex, BSTR* categoryName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{	
...
//		put_ShapeCategory3()
// *************************************************************
void  CShapefile::put_ShapeCategory3(long ShapeIndex, CShapefileCategory* category)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{	
...
void  CShapefile::get_ShapeCategory3(long ShapeIndex, CShapefileCategory** category)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*category = NULL;
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
...
void  CShapefile::get_SelectionDrawingOptions(CShapeDrawingOptions** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _selectDrawOpt;
	return ;
}
void  CShapefile::put_SelectionDrawingOptions(CShapeDrawingOptions* newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (!newVal)
	{
...
void  CShapefile::get_DefaultDrawingOptions(CShapeDrawingOptions** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CShapefile::put_DefaultDrawingOptions(CShapeDrawingOptions* newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
/*		get/put_Categories
/***********************************************************************/
void  CShapefile::get_Categories(CShapefileCategories** pVal)
{
	*pVal = _categories;
	//if (_categories != NULL)
	//	_categories->AddRef();
...
void  CShapefile::put_Categories(CShapefileCategories* newVal)
{
...
//		get_SelectionColor
// ********************************************************************
void  CShapefile::get_SelectionColor(OLE_COLOR* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = _selectionColor;
	return ;
}
void  CShapefile::put_SelectionColor(OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************************
void  CShapefile::get_SelectionTransparency (BYTE* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = _selectionTransparency;
	return ;
}
void  CShapefile::put_SelectionTransparency (BYTE newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************************
void  CShapefile::get_SelectionAppearance(tkSelectionAppearance* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = _selectionAppearance;
	return ;
}
void  CShapefile::put_SelectionAppearance(tkSelectionAppearance newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
// ********************************************************************
void  CShapefile::get_CollisionMode(tkCollisionMode* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = _collisionMode;
	return ;
}
void  CShapefile::put_CollisionMode(tkCollisionMode newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     Serialize()
// ********************************************************
void  CShapefile::Serialize(VARIANT_BOOL SaveSelection, BSTR* retVal)
{
	return Serialize2(SaveSelection, VARIANT_FALSE, retVal);
}

void  CShapefile::Serialize2(VARIANT_BOOL SaveSelection, VARIANT_BOOL SerializeCategories, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
 ...
 CPLXMLNode* CShapefile::SerializeCore(VARIANT_BOOL SaveSelection, CString ElementName, bool serializeCategories)
{
	...
	if (psTree)
	{
		...
		// ----------------------------------------------------
		if (_table) {
			CPLXMLNode* psTable = _table->SerializeCore("TableClass");
			if (psTable) {
...
//     Deserialize()
// ********************************************************
void  CShapefile::Deserialize(VARIANT_BOOL LoadSelection, BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
bool CShapefile::DeserializeCore(VARIANT_BOOL LoadSelection, CPLXMLNode* node)
{
	...
	if (_table) 
	{
		...
		if (psChild)
		{
			_table->DeserializeCore(psChild);
		}
	}
	return true;
}
...
//		get_Projection()
// *****************************************************************
void  CShapefile::get_Projection(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		put_Projection()
// *****************************************************************
void  CShapefile::put_Projection(BSTR proj4Projection)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		get_GeoProjection()
// *****************************************************************
void  CShapefile::get_GeoProjection(CGeoProjection** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	//if (_geoProjection)
...
//		put_GeoProjection()
// *****************************************************************
void  CShapefile::put_GeoProjection(CGeoProjection* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_geoProjection = pVal;
...
//		Reproject()
// *****************************************************************
void  CShapefile::Reproject(CGeoProjection* newProjection, LONG* reprojectedCount, CShapefile** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		ReprojectInPlace()
// *****************************************************************
void  CShapefile::ReprojectInPlace(CGeoProjection* newProjection, LONG* reprojectedCount, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (!_isEditingShapes)
	{
...
//		ReprojectCore()
// *****************************************************************
bool CShapefile::ReprojectCore(CGeoProjection* newProjection, LONG* reprojectedCount, CShapefile** retVal, bool reprojectInPlace)
{
	// ------------------------------------------------------
	//   Validation
	// ------------------------------------------------------
...
//		FixUpShapes()
// *****************************************************************
void  CShapefile::FixUpShapes(CShapefile** retVal, VARIANT_BOOL* fixed)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*fixed = VARIANT_FALSE;
	this->Clone(retVal);
...
//		GetRelatedShapes()
// *********************************************************
void  CShapefile::GetRelatedShapes(long referenceIndex, tkSpatialRelation relation, VARIANT* resultArray, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = VARIANT_FALSE;
...
//		GetRelatedShapes2()
// *********************************************************
void  CShapefile::GetRelatedShapes2(CShape* referenceShape, tkSpatialRelation relation, VARIANT* resultArray, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retval = VARIANT_FALSE;
	if (!referenceShape)	
...
//		GetRelatedShapeCore()
// *********************************************************
void CShapefile::GetRelatedShapeCore(CShape* referenceShape, long referenceIndex, tkSpatialRelation relation, VARIANT* resultArray, VARIANT_BOOL* retval)
{
...
//		get_HotTracking
// ***************************************************
void  CShapefile::get_Identifiable(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _hotTracking;
	return ;
...
void  CShapefile::put_Identifiable(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_hotTracking = newVal;
	return ;
...
//		EditAddField()
// *****************************************************************
void  CShapefile::EditAddField(BSTR name, FieldType type, int precision, int width, long *fieldIndex)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (!this->_table)
	{
...
//		EditAddShape()
// *****************************************************************
void  CShapefile::EditAddShape(CShape* shape, long* shapeIndex)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	VARIANT_BOOL retval;
...
//		GetClosestVertex()
// *****************************************************************
void  CShapefile::GetClosestVertex(double x, double y, double maxDistance, 
...
//		HasInvalidShapes()
// *****************************************************************
void  CShapefile::HasInvalidShapes(VARIANT_BOOL* result)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		get_UndoList()
// *****************************************************************
void  CShapefile::get_UndoList(CUndoList** pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (_undoList)
		delete _undoList;
...
//		Snappable()
// *****************************************************************
void  CShapefile::get_Snappable(VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _snappable;
	return ;
}
void  CShapefile::put_Snappable(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_snappable = newVal;
	return ;
...
//		ShapefileType2D()
// *****************************************************************
void  CShapefile::get_ShapefileType2D(ShpfileType* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		FieldIndexByName()
// *****************************************************************
void  CShapefile::get_FieldIndexByName(BSTR FieldName, LONG* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		Move()
// *****************************************************************
void  CShapefile::Move(DOUBLE xProjOffset, DOUBLE yProjOffset, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
	if (_sourceType != sstInMemory) 
...
//		get_ShapeRendered()
// *****************************************************************
void  CShapefile::get_ShapeRendered(LONG ShapeIndex, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
