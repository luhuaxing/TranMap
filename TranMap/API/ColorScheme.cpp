...
//	 SetColors()
// ***************************************************************
void CColorScheme::SetColors (OLE_COLOR Color1, OLE_COLOR Color2)
{
...
//	 SetColors2()
// ***************************************************************
void CColorScheme::SetColors2 (tkMapColor Color1, tkMapColor Color2)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 SetColors3()
// ***************************************************************
void CColorScheme::SetColors3 (short MinRed, short MinGreen, short MinBlue, short MaxRed, short MaxGreen, short MaxBlue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 SetColors4()
// ***************************************************************
void CColorScheme::SetColors4 (PredefinedColorScheme Scheme)
{
	OLE_COLOR colors[3];
...
//	 Add()
// ***************************************************************
void CColorScheme::AddBreak(double Value, OLE_COLOR Color) //, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 Remove()
// ***************************************************************
void CColorScheme::Remove(long Index, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 get_NumBreaks()
// ***************************************************************
void CColorScheme::get_NumBreaks(long * retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = _breaks.size();
	return ;
...
//	 GenerateRandomColor()
// ********************************************************************
void CColorScheme::get_RandomColor(double Value, OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 GenerateRandomColor()
// ********************************************************************
void CColorScheme::get_GraduatedColor(double Value, OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	 get_BreakColor()
// ********************************************************************
void CColorScheme::get_BreakColor (long Index, OLE_COLOR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())	
	if (Index >= 0 && Index < (long)_breaks.size())
	{
...
//	 put_BreakColor()
// ********************************************************************
void CColorScheme::put_BreakColor (long Index, OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())	
	if (Index >= 0 && Index < (long)_breaks.size())
	{
...
//	 get_BreakValue()
// ********************************************************************
void CColorScheme::get_BreakValue (long Index, double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())	
	if (Index >= 0 && Index < (long)_breaks.size())
	{
...
//*		get_Key()
//***********************************************************************/
void CColorScheme::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	*pVal = OLE2BSTR(_key);
...
void CColorScheme::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
	USES_CONVERSION;
...
void CColorScheme::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
...
void CColorScheme::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CColorScheme::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _globalCallback;
	return ;
}
void CColorScheme::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
