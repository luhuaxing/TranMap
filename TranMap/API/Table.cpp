...
void  CTableClass::ParseExpression(BSTR Expression, BSTR* ErrorString, VARIANT_BOOL* retVal)
{
	*retVal = VARIANT_FALSE;
...
void  CTableClass::TestExpression(BSTR Expression, tkValueType ReturnType, BSTR* ErrorString, VARIANT_BOOL* retVal)
{
...
//		Query()
// *****************************************************************
void  CTableClass::Query(BSTR Expression, VARIANT* Result, BSTR* ErrorString, VARIANT_BOOL* retVal)
{
	*retVal = VARIANT_FALSE;
	SysFreeString(*ErrorString);	// do we need it here?
	USES_CONVERSION;
...
//		Calculate()
// *****************************************************************
void  CTableClass::Calculate(BSTR Expression, LONG RowIndex, VARIANT* Result, BSTR* ErrorString, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	...
	*retVal = VARIANT_FALSE;
	...
	{
		CString err;
		if (expr.ParseExpression(OLE2T(Expression), true, err))
		{
...
//		get_Num_rows
// ***********************************************************
void  CTableClass::get_NumRows(long *pVal)
{
	*pVal = RowCount();
	return ;
}
...
//		get_NumFields
// ***********************************************************
void  CTableClass::get_NumFields(long *pVal)
{
	*pVal = FieldCount();
	return ;
}
...
//		get_Field
// ***********************************************************
void  CTableClass::get_Field(long FieldIndex, CField **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		get_CellValue
// ***********************************************************
void  CTableClass::get_CellValue(long FieldIndex, long RowIndex, VARIANT *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_CellValue
// ***********************************************************
void  CTableClass::get_EditingTable(VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_LastErrorCode
// ***********************************************************
void  CTableClass::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
...
//		get_ErrorMsg
// ***********************************************************
void  CTableClass::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		get_CdlgFilter
// ***********************************************************
void  CTableClass::get_CdlgFilter(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
// ***********************************************************
void  CTableClass::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CTableClass::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	//lu ComHelper::SetRef(newVal, (IDispatch**)&_globalCallback);
	return ;
}
...
//		get/put_Key
// ***********************************************************
void  CTableClass::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	*pVal = OLE2BSTR(_key);
...
void  CTableClass::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	::SysFreeString(_key);
...
//		Open
// ***********************************************************
void  CTableClass::Open(BSTR dbfFilename, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//	  CreateNew()
// **************************************************************
void  CTableClass::CreateNew(BSTR dbfFilename, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	...
	{	
		if( Utility::FileExistsUnicode( OLE2W(dbfFilename) ) )
		{	
			*retval = VARIANT_FALSE;
...
void  CTableClass::Dump(BSTR dbfFilename, ICallback *cBack, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
...
//	  SaveToFile()
// **************************************************************
void  CTableClass::SaveAs(BSTR dbfFilename, ICallback *cBack, VARIANT_BOOL *retval)
{
	USES_CONVERSION;
...
//	  Close()
// **************************************************************
void  CTableClass::Close(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_TRUE;
...
//	  EditClear()
// **************************************************************
void  CTableClass::EditClear(VARIANT_BOOL *retval)
{	
...
//	  EditInsertField()
// **************************************************************
void  CTableClass::EditInsertField(CField *Field, long *FieldIndex, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//	  EditInsertField()
// **************************************************************
void  CTableClass::EditReplaceField(long FieldIndex, CField *newField, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		EditDeleteField()
// *******************************************************************
void  CTableClass::EditDeleteField(long FieldIndex, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//		EditInsertRow()
// *******************************************************************
void  CTableClass::EditInsertRow(long * RowIndex, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
//		EditCellValue()
// *******************************************************************
void  CTableClass::EditCellValue(long FieldIndex, long RowIndex, VARIANT newVal, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
	*retval = VARIANT_FALSE;
...
//		StartEditingTable ()
// *********************************************************
void  CTableClass::StartEditingTable(ICallback *cBack, VARIANT_BOOL *retval)
{  
...
//		StopEditingTable()
// *****************************************************************
void  CTableClass::StopEditingTable(VARIANT_BOOL ApplyChanges, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		EditDeleteRow()
// *******************************************************************
void  CTableClass::EditDeleteRow(long RowIndex, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retval = VARIANT_FALSE;
...
void  CTableClass::Save(ICallback *cBack, VARIANT_BOOL *retval)
{
...
//		get_MinValue
// *********************************************************************
void  CTableClass::get_MinValue(long FieldIndex, VARIANT* retval)
{
...
//		get_MaxValue()
// *********************************************************************
void  CTableClass::get_MaxValue(long FieldIndex, VARIANT* retval)
{
	if( FieldIndex < 0 || FieldIndex >= (long)_fields.size())
	{
		ErrorMessage(tkINDEX_OUT_OF_BOUNDS);
...
//		get_MaxValue()
// *********************************************************************
void  CTableClass::get_MeanValue(long FieldIndex, double* retval)
{
	if( FieldIndex < 0 || FieldIndex >= (long)_fields.size())
	{
		ErrorMessage(tkINDEX_OUT_OF_BOUNDS);
...
//		get_MaxValue()
// *********************************************************************
void  CTableClass::get_StandardDeviation(long FieldIndex, double* retval)
{
	if( FieldIndex < 0 || FieldIndex >= (long)_fields.size())
	{
		ErrorMessage(tkINDEX_OUT_OF_BOUNDS);
...
//		FieldIndexByName()
// *****************************************************************
void  CTableClass::get_FieldIndexByName(BSTR FieldName, long* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		EditAddField()
// *****************************************************************
void  CTableClass::EditAddField(BSTR name, FieldType type, int precision, int width, long* fieldIndex)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		JoinFields()
// *************************************************************
bool CTableClass::JoinFields(CTableClass* table2, std::vector<FieldMapping*>& mapping, set<CString>& fieldList)
{
	USES_CONVERSION;
...
//		Join()
// *****************************************************
void  CTableClass::Join(CTableClass* table2, BSTR fieldTo, BSTR fieldFrom, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	set<CString> fields;
	bool res = this->JoinInternal(table2, OLE2A(fieldTo), OLE2A(fieldFrom), L"", "", fields);
...
//		Join2()
// *****************************************************
void  CTableClass::Join2(CTableClass* table2, BSTR fieldTo, BSTR fieldFrom, BSTR filenameToReopen, BSTR joinOptions, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	set<CString> fields;
...
//		Join3()
// *****************************************************
void  CTableClass::Join3(CTableClass* table2, BSTR fieldTo, BSTR fieldFrom, BSTR filenameToReopen, BSTR joinOptions, SAFEARRAY* filedList, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//		TryJoin()
// *****************************************************
void  CTableClass::TryJoin(CTableClass* table2, BSTR fieldTo, BSTR fieldFrom, int* rowCount, int* joinRowCount, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
	*rowCount = -1;
...
//		CheckJoinInput()
// *****************************************************
bool CTableClass::CheckJoinInput(CTableClass* table2, CString fieldTo, CString fieldFrom, long& index1, long& index2)
{
	if (!table2) 
	{
...
//		JoinInternal()
// *****************************************************
bool CTableClass::JoinInternal(CTableClass* table2, CString fieldTo, CString fieldFrom, CStringW filenameToReopen, CString options, set<CString>& fieldList)
{
	long index1, index2;
...
//		StopJoin()
// *****************************************************
void  CTableClass::StopJoin(int joinIndex, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		get_IsJoined()
// *****************************************************
void  CTableClass::get_IsJoined(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		get_JoinCount()
// *****************************************************
void  CTableClass::get_JoinCount(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _joins.size();
	return ;
...
//		get_FieldIsJoined()
// *****************************************************
void  CTableClass::get_FieldIsJoined(int fieldIndex, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (fieldIndex < 0 || fieldIndex >= (int)_fields.size())
	{
...
//		get_FieldJoinIndex()
// *****************************************************
void  CTableClass::get_FieldJoinIndex(int fieldIndex, int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = -1;
	if (fieldIndex < 0 || fieldIndex >= (int)_fields.size())
...
//		get_JoinFilename()
// *****************************************************
void  CTableClass::get_JoinFilename(int joinIndex, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (joinIndex < 0 || joinIndex >= (int)_joins.size())
	{
...
//		get_JoinFromField()
// *****************************************************
void  CTableClass::get_JoinFromField(int joinIndex, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (joinIndex < 0 || joinIndex >= (int)_joins.size())
	{
...
//		get_JoinToField()
// *****************************************************
void  CTableClass::get_JoinToField(int joinIndex, BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (joinIndex < 0 || joinIndex >= (int)_joins.size())
	{
...
//		Serialize()
// *****************************************************
void  CTableClass::Serialize(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		Deserialize()
// *****************************************************
void  CTableClass::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
		...
		while (node)
		{
			if (strcmp(node->pszValue, "Join") == 0)
			{
				...
				if (filename.GetLength() > 0 && fieldTo.GetLength() > 0 && fieldFrom.GetLength() > 0)
				{
					...
					VARIANT_BOOL vb;
					CTableClass* tableToFill = new CTableClass();
					...
					if (numRows > 0 && numCols > 0)
					{
						...
						USES_CONVERSION;
						this->JoinInternal(tableToFill, fieldTo, fieldFrom, A2W(filename), options, fieldList);
					}
