...
//		get_Point()
// **********************************************************
CPointClass* CShapeWrapper::get_Point(long Index)
{
...
//		put_Point()
// **********************************************************
bool CShapeWrapper::put_Point(long Index, CPointClass* pnt)
{
	if( Index < 0 || Index >= (int)_points.size() )
	{	
		_lastErrorCode = tkINDEX_OUT_OF_BOUNDS;
...
//		InsertPoint()
// ******************************************************
bool CShapeWrapper::InsertPoint(int PointIndex, CPointClass* pnt)
{
	if (!pnt)
	{
		_lastErrorCode = tkUNEXPECTED_NULL_PARAMETER;
