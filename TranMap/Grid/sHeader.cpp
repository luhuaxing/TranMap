...
//DATA ACCESS MEMBERS
 long sHeader::getNumberCols()
{	return ncols;
}

 long sHeader::getNumberRows()
{	return nrows;
}

 short sHeader::getNodataValue()
{	return nodataValue;
}

 double sHeader::getDx()
{	return dx;
}

 double sHeader::getDy()
{	return dy;
}

 double sHeader::getXllcenter()
{	return xllcenter;
}

 double sHeader::getYllcenter()
{	return yllcenter;
}
