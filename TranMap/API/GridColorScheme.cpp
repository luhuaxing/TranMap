...
void  CGridColorScheme::get_NumBreaks(long *pVal)
{
...
void  CGridColorScheme::get_AmbientIntensity(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::put_AmbientIntensity(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void  CGridColorScheme::get_LightSourceIntensity(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::put_LightSourceIntensity(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_LightSourceAzimuth(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_LightSourceElevation(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::SetLightSource(double Azimuth, double Elevation)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::InsertBreak(CGridColorBreak *BrkInfo)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::InsertAt(int Position, CGridColorBreak *Break)
{
	if( Break == NULL )
		return ;
...
void  CGridColorScheme::get_Break(long Index, CGridColorBreak **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::DeleteBreak(long Index)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	
	if( Index >= 0 && Index < (long)_breaks.size() )
	{
		delete _breaks[Index];
...
void  CGridColorScheme::get_NoDataColor(OLE_COLOR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::put_NoDataColor(OLE_COLOR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::UsePredefined(double LowValue, double HighValue, PredefinedColorScheme Preset)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())

	CGridColorBreak* lowbreak = new CGridColorBreak();
	CGridColorBreak* highbreak = new CGridColorBreak();
	...
	if (Preset == Rainbow || Preset == ReversedRainbow)
	{
		...
		OLE_COLOR clr1, clr2;
		CGridColorBreak* br = NULL;
		double step = (HighValue - LowValue) / 6;

		for(int i = 0; i < 6; i++)
		{
			br = new CGridColorBreak();
...
void  CGridColorScheme::GetLightSource(CVector **result)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::get_Key(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CGridColorScheme::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     Serialize()
// ********************************************************
void  CGridColorScheme::Serialize(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
bool CGridColorScheme::DeserializeCore(CPLXMLNode* node)
{
	...
	if (node)
	{
		...
		while (node)
		{
			...
			{
				CGridColorBreak* br = new CGridColorBreak();
...
//     Deserialize()
// ********************************************************
void  CGridColorScheme::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//     ReadFrom()
// ********************************************************
void  CGridColorScheme::ReadFromFile(BSTR mwlegFilename, BSTR nodeName, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     WriteTo()
// ********************************************************
void  CGridColorScheme::WriteToFile(BSTR mwlegFilename, BSTR gridName, int bandIndex, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     ApplyColoringType()
// ********************************************************
void  CGridColorScheme::ApplyColoringType(ColoringType coloringType)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     ApplyGradientModel()
// ********************************************************
void  CGridColorScheme::ApplyGradientModel(GradientModel gradientModel)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	for(size_t i = 0; i < _breaks.size(); i++)
	{
