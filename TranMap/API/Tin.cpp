...
void CTin::Open(BSTR TinFile, ICallback *cBack, VARIANT_BOOL *retval)
{
...
void CTin::CreateNew(CGrid *Grid, double Deviation, SplitMethod SplitTest, double STParam, long MeshDivisions, long MaximumTriangles, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Save(BSTR TinFilename, ICallback *cBack, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
void CTin::Close(VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Select(long * TriangleHint, double X, double Y, double *Z, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_NumTriangles(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_NumVertices(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_CdlgFilter(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Triangle(long TriIndex, long *vtx1Index, long *vtx2Index, long *vtx3Index)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::TriangleNeighbors(long TriIndex, long *triIndex1, long *triIndex2, long *triIndex3)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Vertex(long VtxIndex, double *X, double *Y, double *Z)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Max(double *X, double *Y, double *Z)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::Min(double *X, double *Y, double *Z)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_Filename(BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::get_IsNDTriangle(long TriIndex, VARIANT_BOOL *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void CTin::CreateTinFromPoints(SAFEARRAY * Points, VARIANT_BOOL* retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	...
	v = new XYZ[nv];
	CPointClass **Data = (CPointClass**)Points->pvData;
	double x = 0.0;
	(*Data[0]).get_X(&x);
	for(int i =0; i < nv;i++)
	{
