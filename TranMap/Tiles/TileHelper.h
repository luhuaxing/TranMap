...
{
public:
	static double GetTileSizeProj(VARIANT_BOOL isSameProjection, BaseProvider* provider, CGeoProjection* wgsToMapTransformation, PointLatLng& location, int zoom);
	static bool Transform(RectLatLng& Geog, CGeoProjection* proj, BaseProjection* baseProj, 
