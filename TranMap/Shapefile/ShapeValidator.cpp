...
//		Validate()
// ***************************************************************
CShapeValidationInfo* ShapeValidator::Validate(CShapefile* isf, tkShapeValidationMode validationMode, 
			...
			ICallback* callback, BSTR& key, bool selectedOnly, bool reportOnly)
{
	...
	CShapeValidationInfo* iinfo = new CShapeValidationInfo();
