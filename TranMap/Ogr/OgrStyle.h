...
public:
	...
	static bool SaveStyle(GDALDataset* dataset, CShapefile* shapefile, CStringW layerName, CStringW styleName);
	static bool SaveStyle(GDALDataset* dataset, CStringW xml, CStringW layerName, CStringW styleName);
	static CStringW GetStyleTableName(CStringW layerName = L"");
