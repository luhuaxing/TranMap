...
BEGIN_MESSAGE_MAP(CTranMapApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTranMapApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CTranMapApp::CTranMapApp()
{
	...
	SetAppID(_T("TranMap.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CTranMapApp 对象
