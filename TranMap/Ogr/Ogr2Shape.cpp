...
//		Layer2Shapefile()
// *************************************************************
CShapefile* Ogr2Shape::Layer2Shapefile(OGRLayer* layer, int maxFeatureCount, bool& isTrimmed, 
	OgrDynamicLoader* loader, ICallback* callback /*= NULL*/)
{
	if (!layer)	return NULL;

	CShapefile* sf = CreateShapefile(layer);
...
//		CreateShapefile()
// *************************************************************
CShapefile* Ogr2Shape::CreateShapefile(OGRLayer* layer)
{
	layer->ResetReading();
...
//		FillShapefile()
// *************************************************************
bool Ogr2Shape::FillShapefile(OGRLayer* layer, CShapefile* sf, int maxFeatureCount, bool loadLabels, ICallback* callback, bool& isTrimmed)
{
