...
void  CShapefile::SelectShapes(CExtents *BoundBox, double Tolerance, SelectMode SelectMode, VARIANT *Result, VARIANT_BOOL *retval)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
    *retval = VARIANT_FALSE;

//lu	selectShapesMutex.Lock();
...
bool CShapefile::SelectShapesCore(Extent& extents, double Tolerance, SelectMode SelectMode, std::vector<long>& selectResult, bool renderedOnly)
{
	...
	CExtents* box = ExtentsHelper::Populate(extents);
...
void  CShapefile::get_ShapeSelected(long ShapeIndex, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CShapefile::put_ShapeSelected(long ShapeIndex, VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if( ShapeIndex < 0 || ShapeIndex >= (long)_shapeData.size())
	{	
...
//		get_NumSelected
// *************************************************************
void  CShapefile::get_NumSelected(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//     InvertSelection()
// *************************************************************
void  CShapefile::InvertSelection()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
