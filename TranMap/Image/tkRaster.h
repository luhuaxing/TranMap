...
public:
	...
	{	//Rob Cairns
		...
		_predefinedColorScheme = new CGridColorScheme();
	};
	~tkRaster()
	{
		Close();
...
private:
	...
	CGridColorScheme * _customColorScheme;		// the one set by Image.GridColorScheme property
	CGridColorScheme * _predefinedColorScheme;		// the one set by Image.ImageColorScheme property
...
private:
	...
	CGridColorScheme* tkRaster::GetColorSchemeForRendering();		// returns either of the 2 available
...
public:
	...
	void ApplyCustomColorScheme(CGridColorScheme * scheme) { _customColorScheme = scheme;	}
	void ApplyPredefinedColorScheme(PredefinedColorScheme colorScheme);
	CGridColorScheme* get_CustomColorScheme() { return _customColorScheme; }
