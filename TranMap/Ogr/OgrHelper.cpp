...
//		GetFieldType()
// *************************************************************
OGRFieldType OgrHelper::GetFieldType(CField* fld)
{
	FieldType type;
	fld->get_Type(&type);
	switch (type)
...
//		Cast()
// *************************************************************
COgrLayer* OgrHelper::Cast(COgrLayer*& layer)
{
...
//		ShapeType2D()
// *************************************************************
ShpfileType OgrHelper::ShapeType2D(COgrLayer* layer)
{
...
// *************************************************************
COgrLayer* OgrHelper::ChooseLayerByShapeType(COgrDatasource* ds, ShpfileType shpType, VARIANT_BOOL forUpdate)
{
...
//		GetLayerCount()
// *************************************************************
int OgrHelper::GetLayerCount(COgrDatasource* ds)
{
	if (!ds) return 0;
	int layerCount;
...
//		GetSourceType()
// *************************************************************
tkOgrSourceType OgrHelper::GetSourceType(COgrLayer* layer)
{
...
//		CastDatasource()
// *************************************************************
COgrDatasource* CastDatasource(COgrDatasource*& ds)
{
