...
//		ClearPrefetchErrors()
// ************************************************************
void  CTiles::ClearPrefetchErrors()
{
...
// ************************************************************
void  CTiles::get_PrefetchTotalCount(int *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_PrefetchErrorCount()
// ************************************************************
void  CTiles::get_PrefetchErrorCount(int *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		get_GlobalCallback()
// ************************************************************
void  CTiles::get_GlobalCallback(ICallback **pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//		put_GlobalCallback()
// ************************************************************
void  CTiles::put_GlobalCallback(ICallback *newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	   get_ErrorMsg()
// *****************************************************************
void  CTiles::get_ErrorMsg(long ErrorCode, BSTR *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//		get_LastErrorCode()
// ************************************************************
void  CTiles::get_LastErrorCode(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _lastErrorCode;
...
void  CTiles::put_Key(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	::SysFreeString(_key);
...
// *********************************************************
void  CTiles::get_SleepBeforeRequestTimeout(long *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _prefetchLoader.m_sleepBeforeRequestTimeout;
	return ;
}
void  CTiles::put_SleepBeforeRequestTimeout(long newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	     ScalingRatio()
// *********************************************************
void  CTiles::get_ScalingRatio(double *pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*pVal = _scalingRatio;
	return ;
}
void  CTiles::put_ScalingRatio(double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//	     AutodetectProxy()
// *********************************************************
void  CTiles::AutodetectProxy(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     SetProxy()
// *********************************************************
void  CTiles::SetProxy(BSTR address, int port, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
// *********************************************************
void  CTiles::SetProxyAuthentication(BSTR username, BSTR password, BSTR domain, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	*retVal = m_provider->SetProxyAuthorization(OLE2T(username), OLE2T(password), OLE2T(domain)) ? VARIANT_TRUE : VARIANT_FALSE;
	return ;
}
...
// *********************************************************
void  CTiles::ClearProxyAuthorization()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     get_Proxy()
// *********************************************************
void  CTiles::get_Proxy(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
	CString s;
...
//		ChooseZoom()
// ************************************************************
int CTiles::ChooseZoom(CExtents* ext, double pixelPerDegree, bool limitByProvider, BaseProvider* provider)
{
...
//		get_CurrentZoom()
// ************************************************************
void  CTiles::get_CurrentZoom(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = -1;
	CMapView* map = (CMapView*)this->_mapView;
	if (map) {
		CExtents* ext = map->GetGeographicExtents();
		if (ext) {
...
bool CTiles::GetTilesForMap(void* mapView, int providerId, int& xMin, int& xMax, int& yMin, int& yMax, int& zoom)
{
	...
	CExtents* ext = map->GetGeographicExtentsCore(clipForTiles, &clipExtents);
	if (!ext) {
		return false;
	}
...
//	     Provider
// *********************************************************
void  CTiles::get_Provider(tkTileProvider* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CTiles::put_Provider(tkTileProvider newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     get_ProviderName
// *********************************************************
void  CTiles::get_ProviderName(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//	     GridLinesVisible
// *********************************************************
void  CTiles::get_GridLinesVisible(VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _gridLinesVisible;
	return ;
}
void  CTiles::put_GridLinesVisible(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     MinScaleToCache
// *********************************************************
void  CTiles::get_MinScaleToCache(int* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _minScaleToCache;		// TODO: use in caching process
	return ;
}
void  CTiles::put_MinScaleToCache(int newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     MaxScaleToCache
// *********************************************************
void  CTiles::get_MaxScaleToCache(int* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _maxScaleToCache;		// TODO: use in caching process
	return ;
}
void  CTiles::put_MaxScaleToCache(int newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     Visible
// *********************************************************
void  CTiles::get_Visible(VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _visible;
	return ;
...
void  CTiles::put_Visible(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_visible = newVal != 0;
	return ;
...
//	     CustomProviders
// *********************************************************
void  CTiles::get_Providers(CTileProviders** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = _providers;
	return ;
...
//	     DoCaching
// *********************************************************
void  CTiles::get_DoCaching(tkCacheType type, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
void  CTiles::put_DoCaching(tkCacheType type, VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
//	     UseCache
// *********************************************************
void  CTiles::get_UseCache(tkCacheType type, VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
void  CTiles::put_UseCache(tkCacheType type, VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
//	     UseServer
// *********************************************************
void  CTiles::get_UseServer(VARIANT_BOOL* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal = _useServer;
	return ;
}
void  CTiles::put_UseServer(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	_useServer = newVal != 0;
	return ;
...
// *********************************************************
void  CTiles::get_DiskCacheFilename(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
// *********************************************************
void  CTiles::put_DiskCacheFilename(BSTR pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//	     MaxCacheSize
// *********************************************************
void  CTiles::get_MaxCacheSize(tkCacheType type, double* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
void  CTiles::put_MaxCacheSize(tkCacheType type, double newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
//	     ClearCache()
// *********************************************************
void  CTiles::ClearCache(tkCacheType type)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
//	     ClearCache2()
// *********************************************************
void  CTiles::ClearCache2(tkCacheType type, tkTileProvider provider, int fromScale, int toScale)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	switch(type)
	{
...
//	     get_CacheSize()
// *********************************************************
void  CTiles::get_CacheSize(tkCacheType type, double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = 0.0;
	switch(type)
...
void  CTiles::get_CacheSize2(tkCacheType type, tkTileProvider provider, int scale, double* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = 0.0;
	switch(type)
...
//     Serialize()
// ********************************************************
void  CTiles::Serialize(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//     Deserialize()
// ********************************************************
void  CTiles::Deserialize(BSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	USES_CONVERSION;
...
//	     CustomProviderId
// *********************************************************
void  CTiles::get_ProviderId(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void  CTiles::put_ProviderId(int providerId)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	BaseProvider* provider = ((CTileProviders*)_providers)->get_Provider(providerId);
	if (provider) {
...
//	     GetTilesIndices
// *********************************************************
void  CTiles::GetTilesIndices(CExtents* boundsDegrees, int zoom, int providerId, CExtents** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (!boundsDegrees)
	{
...
//	     Prefetch
// *********************************************************
void  CTiles::Prefetch(double minLat, double maxLat, double minLng, double maxLng, int zoom, int providerId, 
							  CStopExecution* stop, LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     Prefetch2
// *********************************************************
void  CTiles::Prefetch2(int minX, int maxX, int minY, int maxY, int zoom, int providerId, CStopExecution* stop, LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     StartLogRequests()
// *********************************************************
void  CTiles::StartLogRequests(BSTR filename, VARIANT_BOOL errorsOnly, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//	     LogIsOpened()
// *********************************************************
void  CTiles::get_LogIsOpened(VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = tilesLogger.IsOpened();
	return ;
...
//	     LogFilename()
// *********************************************************
void  CTiles::get_LogFilename(BSTR* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	USES_CONVERSION;
...
//	     LogErrorsOnly()
// *********************************************************
void  CTiles::get_LogErrorsOnly(VARIANT_BOOL *retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	*retVal = tilesLogger.errorsOnly;
	return ;
}
void  CTiles::put_LogErrorsOnly(VARIANT_BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
void  CTiles::PrefetchToFolder(CExtents* ext, int zoom, int providerId, BSTR savePath, BSTR fileExt, CStopExecution* stop, LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = 0;
...
long CTiles::PrefetchCore(int minX, int maxX, int minY, int maxY, int zoom, int providerId, 
								  BSTR savePath, BSTR fileExt, CStopExecution* stop)
{
	BaseProvider* provider = ((CTileProviders*)_providers)->get_Provider(providerId);
	if (!provider)
	{
	...
	if (type == CacheType::DiskCache)
	{
		...
		if (ext.GetLength() >= 4)
		{
			CStringW s = A2W(ext.Mid(0, 4).MakeLower()); // try to guess it from input
			if (s == L".png")
			{
...
//	     get_DiskCacheCount
// *********************************************************
void  CTiles::get_DiskCacheCount(int provider, int zoom, int xMin, int xMax, int yMin, int yMax, LONG* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//	     CheckConnection
// *********************************************************
void  CTiles::CheckConnection(BSTR url, VARIANT_BOOL* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if (m_provider != NULL)
	{
...
//	     get_TileBounds
// *********************************************************
void  CTiles::GetTileBounds(int provider, int zoom, int tileX, int tileY, CExtents** retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = VARIANT_FALSE;
...
// ************************************************************
bool CTiles::ProjectionSupportsWorldWideTransform( CGeoProjection* mapProjection, CGeoProjection* wgsProjection )
{
...
//		ProjectionBounds
// ************************************************************
bool CTiles::ProjectionBounds( BaseProvider* provider, CGeoProjection* mapProjection, CGeoProjection* wgsProjection, tkTransformationMode transformationMode, Extent& retVal )
{
...
//		get_MaxZoom
// ************************************************************
void  CTiles::get_MaxZoom(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		put_MinZoom
// ************************************************************
void  CTiles::get_MinZoom(int* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		ServerProjection
// ************************************************************
void  CTiles::get_ServerProjection(tkTileProjection* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//		ProjectionStatus
// ************************************************************
void  CTiles::get_ProjectionStatus(tkTilesProjectionStatus* retVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*retVal = tkTilesProjectionStatus::tpsEmptyOrInvalid;
	...
	CMapView* map = ((CMapView*)this->_mapView);
	if (map) {
		CGeoProjection* gp = map->GetMapProjection();
		CGeoProjection* gpServer = NULL;
...
// ************************************************************
void  CTiles::get_ProxyAuthenticationScheme(tkProxyAuthentication* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	*pVal  = m_globalSettings.proxyAuthentication;
	return ;
}
void  CTiles::put_ProxyAuthenticationScheme(tkProxyAuthentication newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
