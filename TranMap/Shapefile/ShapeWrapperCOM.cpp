...
//		get_Point()
// ********************************************************
CPointClass* CShapeWrapperCOM::get_Point(long Index)
{
...
//		put_Point()
// ********************************************************
bool CShapeWrapperCOM::put_Point(long Index, CPointClass* pnt)
{
	if( Index < 0 || Index >= (long)_allPoints.size() )
	{	
		_lastErrorCode = tkINDEX_OUT_OF_BOUNDS;
...
//		InsertPoint()
// ******************************************************
bool CShapeWrapperCOM::InsertPoint(int PointIndex, CPointClass* point)
{
	if( _ShapeType == SHP_NULLSHAPE )
	{	
		return false;
...
bool CShapeWrapperCOM::DeletePoint(int PointIndex)
{
	...
	{	
		if(_allPoints[PointIndex])
		delete _allPoints[PointIndex];
