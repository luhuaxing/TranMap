...
{	
 ...
 long lGrid::getValue( int Column, int Row )
{
	if( inGrid( Column, Row ) )
	{
		if( isInRam )
 ...
 long lGrid::getValueDisk( int Column, int Row )
{	if( gridType == ASCII_GRID )
		return gridHeader.getNodataValue();
	else if( gridType == BINARY_GRID )
...
{		
 ...
 void lGrid::setValueDisk( int Column, int Row, long Value )
{	if( gridType == ASCII_GRID )
		return;
	else if( gridType == BINARY_GRID )
...
{	if( gridType == ASCII_GRID )
 ...
 bool lGrid::inGrid( long column, long row )
{
